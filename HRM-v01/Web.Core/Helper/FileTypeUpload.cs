...
namespace Web.Core
{
    public static class FileTypeUpload
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        public static List<string> DocumentExtension()
        {
            return new List<string>
            {
                ".doc",
        ...
        /// </summary>
        /// <returns></returns>
        public static List<string> MediaExtension()
        {
            return new List<string>
            {
                ".flv",
        ...
        /// <returns></returns>
        public static bool IsAllowImageFileExtension(string fileExtension)
        {
            return ImageExtension().Any(s => s == fileExtension);
        }
        ...
        /// <param name="fileExtension"></param>
        /// <returns></returns>
        public static bool IsAllowDocumentFileExtension(string fileExtension)
        {
            return DocumentExtension().Any(s => s == fileExtension);
        }
        ...
        /// <param name="fileExtension"></param>
        /// <returns></returns>
        public static bool IsAllowVideoExtension(string fileExtension)
        {
            return MediaExtension().Any(s => s == fileExtension);
        }
