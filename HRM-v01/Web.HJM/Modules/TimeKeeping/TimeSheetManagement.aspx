<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.TimeKeeping.TimeSheetManagement" Codebehind="TimeSheetManagement.aspx.cs" %>
                            ...
                            <ext:GridPanel ID="gridTimeSheet" TrackMouseOver="true" Header="true" runat="server"
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="TotalPaidLeaveT" Header="Tổng số ngày nghỉ phép hưởng lương (T)" Width="150" Align="Left" DataIndex="TotalPaidLeaveT">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TotalUnpaidLeaveP" Header="Tổng số ngày nghỉ phép không hưởng lương (P)" Width="150" Align="Left" DataIndex="TotalUnpaidLeaveP">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
