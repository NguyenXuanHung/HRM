<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.TimeKeeping.TimeSheetManagementManual" Codebehind="TimeSheetManagementManual.aspx.cs" %>
...
<head runat="server">
    <title></title>
    <link type="text/css" href="/Resource/css/CustomStyle.css" rel="stylesheet" />
    ...
    <style type="text/css">
        #gridTimeSheet .x-grid3-cell-inner, .x-grid3-hd-inner {
    ...
    <script type="text/javascript">
        ...
        function ValidateInputTimeSheetAllEmployee() {
            if (timeSheetFromDate.getValue() == "" || timeSheetFromDate.getValue() == null) {
                alert('Bạn chưa chọn ngày bắt đầu');
                return false;
            }
            if (timeSheetToDate.getValue() == "" || timeSheetToDate.getValue() == null) {
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Window runat="server" Title="Cập nhật thông tin chấm công" Resizable="true" Layout="FormLayout"
                ...
                <Items>
                    <ext:Container ID="Container3" runat="server" Layout="Column" Height="30">
                        <Items>
                            <ext:Container ID="Container1" runat="server" LabelAlign="left" Layout="Form" ColumnWidth=".5"
                                LabelWidth="120" >
                                <Items>
                                    <ext:TextField runat="server" ID="txtUpdateAdjustDate" FieldLabel="Ngày hiệu chỉnh" Width="70px" ReadOnly="True" />
                                </Items>
                            </ext:Container>
                    ...
                    <ext:GridPanel ID="gridUpdateTimeSheet" runat="server" Height="450" AnchorHorizontal="100%"
            ...
            <ext:Window runat="server" Title="Tạo mới thông tin chấm công" Resizable="true" Layout="FormLayout"
                ...
                <Items>
                    ...
                    <ext:GridPanel ID="gridStatusWork" runat="server" Height="450" AnchorHorizontal="100%"
                        ...
                        <Store>
                            <ext:Store ID="storeStatusWork" AutoSave="true" runat="server" GroupField="GroupSymbolName" AutoLoad="True">
                                <Proxy>
                                    <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                </Proxy>
                                <AutoLoadParams>
            ...
            <ext:Window runat="server" Title="Chấm công theo ngày cho tất cả nhân viên" Resizable="true" Layout="FormLayout"
                ...
                <Items>
                    <ext:Container runat="server" AnchorHorizontal="100%" Layout="FormLayout">
                        <Items>
                            <ext:FieldSet ID="FieldSet1" runat="server" Title="Tình trạng làm việc"
                                Layout="FormLayout" Height="400">
                                <Items>
                                    <ext:RadioGroup ID="groupPaySalaryAllEmp" runat="server" FieldLabel="Hưởng lương"
                                        GroupName="groupPaySalaryAllEmp" ColumnsNumber="1" Height="50">
                                        <Items>
                                            <ext:Radio runat="server" BoxLabel="Một ngày công" ID="chkFullDayAllEmp" Checked="true" />
                                            <ext:Radio runat="server" BoxLabel="Nửa ngày công" ID="chkHalfDayAllEmp" />
                                        </Items>
                                    </ext:RadioGroup>
                                    <ext:Container ID="Container18" runat="server" Layout="Column" Height="30">
                                        <Items>
                                            <ext:Container ID="Container19" runat="server" LabelWidth="100" LabelAlign="left"
                                            ...
                                            <ext:Container ID="Container4" runat="server" LabelAlign="left" LabelWidth="100" Layout="Form"
                                                ColumnWidth=".5">
                                                <Items>
                                    ...
                                    <ext:CompositeField AnchorHorizontal="100%" runat="server">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbxSaturday" runat="server"
                                                AnchorHorizontal="100%" SelectedIndex="0" AllowBlank="false" Width="120" Disabled="true">
                                                <Items>
                                                    <ext:ListItem Text="Một ngày công" Value="1" />
                                                    <ext:ListItem Text="Nửa ngày công" Value="0.5" />
                                                </Items>
                                            </ext:ComboBox>
                                        </Items>
                                    </ext:CompositeField>
                                    <ext:CompositeField AnchorHorizontal="100%" runat="server">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbxSunday" runat="server"
                                                AnchorHorizontal="100%" SelectedIndex="0" AllowBlank="false" Width="120" Disabled="true">
                                                <Items>
                                                    <ext:ListItem Text="Một ngày công" Value="1" />
                                                    <ext:ListItem Text="Nửa ngày công" Value="0.5" />
            ...
            <ext:Window Modal="true" Hidden="true" runat="server" ID="wdCreateTimeSheet" Constrain="true"
                ...
                <Items>
                    <ext:ComboBox runat="server" ID="cbxDepartment" FieldLabel="Chọn bộ phận"
                        ...
                        <Listeners>
                            <Select Handler="this.triggers[0].show();hdfDepartmentId.setValue(cbxDepartment.getValue());hdfDepartmentSelectedId.setValue(cbxDepartment.getValue());" />
                ...
                <Buttons>
                    <ext:Button ID="btnCreateTimeSheetReport" runat="server" Icon="Accept" Text="Tạo bảng công">
                        ...
                        <DirectEvents>
                            <Click OnEvent="CreateTimeSheetReport_Click">
            ...
            <ext:Window Modal="true" Hidden="true" runat="server" ID="wdSelectTimeSheetReport" Constrain="true"
                ...
                <Items>
                    ...
                    <ext:GridPanel ID="gridSelectTimeSheetReport" runat="server" StripeRows="true" Border="false"
                        ...
                        <SelectionModel>
                            <ext:CheckboxSelectionModel SingleSelect="true" ID="RowSelectionModelSelectTimeSheetReport" runat="server">
                                <Listeners>
                                    <RowSelect Handler="hdfSelectTimeSheetReportId.setValue(RowSelectionModelSelectTimeSheetReport.getSelected().get('Id'));"></RowSelect>
                                </Listeners>
                            </ext:CheckboxSelectionModel>
                        </SelectionModel>
                        <BottomBar>
            ...
            <script>
                function RenderDay(value) {
                    ...
                    return "<div style='width:100%;heigh:100%;' onclick='intTimeSheetInput(" +
                    ...
                    <ext:BorderLayout Border="false" Header="false" runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridTimeSheet" TrackMouseOver="true" Header="true" runat="server"
                                StripeRows="true" Border="false" AnchorHorizontal="100%" Title="Chưa có thông tin về bảng chấm công" Icon="Date">
                                <TopBar>
                                    <ext:Toolbar runat="server" ID="tb">
                                        <Items>
                                            ...
                                            <ext:Button ID="btnChooseEmployee" runat="server" Text="Chọn cán bộ" Icon="UserAdd" Hidden="True">
                                                <Listeners>
                                            ...
                                            <ext:Button ID="btnExtension" runat="server" Text="Tiện ích" Icon="Build">
                                                <Menu>
                                                    <ext:Menu ID="menuExtension" runat="server">
                                                        <Items>
                                                            <ext:MenuItem ID="itemExtension" runat="server" Text="Chấm công ngày hôm nay cho tất cả nhân viên">
                                                                <Listeners>
                                                                    <Click Handler="wdTimeSheetAllEmployee.show();" />
                                                                </Listeners>
                                                            </ext:MenuItem>
                                                            <ext:MenuItem ID="itemCalculateAllEmployee" runat="server" Text="Tính số công cho tất cả nhân viên">
                                                                <DirectEvents>
                                                                    <Click OnEvent="CalculateAllEmployee">
                                                                        <EventMask ShowMask="true" Msg="Đang xử lý dữ liệu. Vui lòng chờ..." />
                                                                    </Click>
                                                                </DirectEvents>
                                                            </ext:MenuItem>
                                                            <ext:MenuItem ID="itemCalculateEmpSelected" runat="server" Text="Tính số công cho nhân viên được chọn" Hidden="true">
                                                            </ext:MenuItem>
                                                            <ext:MenuItem ID="itemDeleteTimeSheet" runat="server" Text="Xóa bảng chấm công">
                                                                <DirectEvents>
                                                                    <Click OnEvent="DeleteTimeSheet">
                                                                        <EventMask ShowMask="true" Msg="Đang xử lý dữ liệu. Vui lòng chờ..." />
                                                                    </Click>
                                                                </DirectEvents>
                                                            </ext:MenuItem>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeTimeSheet">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/HandlerTimeSheetManual.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
                                            <ext:Parameter Name="start" Value="={0}" />
                                            <ext:Parameter Name="limit" Value="={15}" />
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="TotalActual" Header="Tổng số ngày công thực tế" Width="150" Align="Left" Locked="true" DataIndex="TotalActual">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TotalHolidayL" Header="Tổng nghỉ lễ (L)" Width="150" Align="Left" Locked="true" DataIndex="TotalHolidayL">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TotalPaidLeaveT" Header="Tổng số ngày nghỉ phép hưởng lương (T)" Width="150" Align="Left" Locked="true" DataIndex="TotalPaidLeaveT">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TotalUnpaidLeaveP" Header="Tổng số ngày nghỉ phép không hưởng lương (P)" Width="150" Align="Left" Locked="true" DataIndex="TotalUnpaidLeaveP">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TotalGoWorkC" Header="Tổng công tác (C)" Align="Left" Locked="true" DataIndex="TotalGoWorkC">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TotalUnleaveK" Header="Tổng công nghỉ không phép (K)" Width="150" Align="Left" Locked="true" DataIndex="TotalUnleaveK">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TotalLateM" Header="Tổng số ngày đi trễ (M)" Width="150" Align="Left" Locked="true" DataIndex="TotalLateM">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day1" Header="Day 1" Width="100" Align="Left" Locked="true" DataIndex="Day1">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day2" Header="Day 2" Width="100" Align="Left" Locked="true" DataIndex="Day2">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day3" Header="Day 3" Width="100" Align="Left" Locked="true" DataIndex="Day3">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day4" Header="Day 4" Width="100" Align="Left" Locked="true" DataIndex="Day4">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day5" Header="Day 5" Width="100" Align="Left" Locked="true" DataIndex="Day5">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day6" Header="Day 6" Width="100" Align="Left" Locked="true" DataIndex="Day6">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day7" Header="Day 7" Width="100" Align="Left" Locked="true" DataIndex="Day7">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day8" Header="Day 8" Width="100" Align="Left" Locked="true" DataIndex="Day8">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day9" Header="Day 9" Width="100" Align="Left" Locked="true" DataIndex="Day9">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day10" Header="Day 10" Width="100" Align="Left" Locked="true" DataIndex="Day10">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day11" Header="Day 11" Width="100" Align="Left" Locked="true" DataIndex="Day11">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day12" Header="Day 12" Width="100" Align="Left" Locked="true" DataIndex="Day12">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day13" Header="Day 13" Width="100" Align="Left" Locked="true" DataIndex="Day13">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day14" Header="Day 14" Width="100" Align="Left" Locked="true" DataIndex="Day14">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day15" Header="Day 15" Width="100" Align="Left" Locked="true" DataIndex="Day15">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day16" Header="Day 16" Width="100" Align="Left" Locked="true" DataIndex="Day16">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day17" Header="Day 17" Width="100" Align="Left" Locked="true" DataIndex="Day17">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day18" Header="Day 18" Width="100" Align="Left" Locked="true" DataIndex="Day18">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day19" Header="Day 19" Width="100" Align="Left" Locked="true" DataIndex="Day19">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day20" Header="Day 20" Width="100" Align="Left" Locked="true" DataIndex="Day20">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day21" Header="Day 21" Width="100" Align="Left" Locked="true" DataIndex="Day21">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day22" Header="Day 22" Width="100" Align="Left" Locked="true" DataIndex="Day22">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day23" Header="Day 23" Width="100" Align="Left" Locked="true" DataIndex="Day23">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day24" Header="Day 24" Width="100" Align="Left" Locked="true" DataIndex="Day24">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day25" Header="Day 25" Width="100" Align="Left" Locked="true" DataIndex="Day25">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day26" Header="Day 26" Width="100" Align="Left" Locked="true" DataIndex="Day26">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day27" Header="Day 27" Width="100" Align="Left" Locked="true" DataIndex="Day27">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day28" Header="Day 28" Width="100" Align="Left" Locked="true" DataIndex="Day28">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day29" Header="Day 29" Width="100" Align="Left" Locked="true" DataIndex="Day29">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day30" Header="Day 30" Width="100" Align="Left" Locked="true" DataIndex="Day30">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                        <ext:Column ColumnID="Day31" Header="Day 31" Width="100" Align="Left" Locked="true" DataIndex="Day31">
                                            <Renderer Fn="RenderDay" />
                                        </ext:Column>
                                    </Columns>
                                </ColumnModel>
