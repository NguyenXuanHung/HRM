<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.TimeKeeping.TimeSheetAdjustment" Codebehind="TimeSheetAdjustment.aspx.cs" %>
                        ...
                        <ext:GridPanel ID="gridTimeAdjust" TrackMouseOver="true" Header="false" runat="server"
                                ...
                                <ext:Toolbar runat="server" ID="tb">
                                    <Items>
                                        <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                            <Listeners>
                                                <Click Handler="wdAdjustment.show();btnAdjust.disable();" />
                                            </Listeners>
                                        </ext:Button>
                            ...
                            <Store>
                                <ext:Store runat="server" ID="storeAdjustment">
                                    ...
                                    <BaseParams>
                                        <ext:Parameter Name="handlers" Value="TimeSheetAdjustment"/>
                ...
                <ext:Container ID="Container1" runat="server" Layout="Column" Height="80">
                    <Items>
                        <ext:Container ID="Container2" runat="server" LabelAlign="left" Layout="Form" ColumnWidth=".5"
                            LabelWidth="120">
                            <Items>
                                <ext:Button runat="server" ID="btnAdjust" Text="Hiệu chỉnh chấm công" Disabled="True">
                                    <Listeners>
                                        <Click Handler="wdTimeSheetAdd.show();"></Click>
                                    </Listeners>
                                </ext:Button>
