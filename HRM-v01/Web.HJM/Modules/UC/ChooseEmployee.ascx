<%@ Control Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.UC.ChooseEmployee" Codebehind="ChooseEmployee.ascx.cs" %>
                ...
                <ext:GridPanel runat="server" ID="EmployeeGrid" Icon="UserAdd" Header="false" Title="Danh sách nhân viên"
                    ...
                    <Store>
                        <ext:Store ID="Store3" ShowWarningOnFailure="false" runat="server" AutoLoad="True">
                            ...
                            <Reader>
                                <ext:JsonReader Root="Data" IDProperty="EmployeeCode" TotalProperty="TotalRecords">
                                    <Fields>
