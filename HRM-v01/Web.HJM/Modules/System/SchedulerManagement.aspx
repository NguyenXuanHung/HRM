<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.System.SchedulerManagement" CodeBehind="SchedulerManagement.aspx.cs" %>
    ...
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Store runat="server" ID="storeScheduler" AutoSave="true">
                ...
                <BaseParams>
                    <ext:Parameter Name="schedulerTimeSheetHandlerType" Value="cbxSchedulerTimeSheetHandlerTypeFilter.getValue()" Mode="Raw" />
                    <ext:Parameter Name="repeatTimeSheetHandlerType" Value="cbxSchedulerRepeatTimeSheetHandlerTypeFilter.getValue()" Mode="Raw" />
                ...
                <Reader>
                    <ext:JsonReader IDProperty="Id" Root="Data" TotalProperty="TotalRecords">
                        <Fields>
                            ...
                            <ext:RecordField Name="SchedulerTimeSheetHandlerTypeId" />
                            <ext:RecordField Name="SchedulerTimeSheetHandlerTypeName" />
                            <ext:RecordField Name="Arguments" />
                            <ext:RecordField Name="RepeatTimeSheetHandlerType" />
                            <ext:RecordField Name="RepeatTimeSheetHandlerTypeName" />
                            ...
                            <ext:GridPanel runat="server"
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="LastRunTime" Header="Lần chạy cuối" Width="150" DataIndex="LastRunTime" />
                                        <ext:Column ColumnID="NextRunTime" Header="Lần chạy tiếp" Width="150" DataIndex="NextRunTime" />
                                        <ext:Column ColumnID="Status" Header="Trạng thái" Width="150" DataIndex="StatusName" />
                                        <ext:Column ColumnID="SchedulerTimeSheetHandlerType" Header="Loại" Width="150" DataIndex="SchedulerTimeSheetHandlerTypeName" />
                                        <ext:Column ColumnID="RepeatTimeSheetHandlerType" Header="Kiểu lặp" Width="100" DataIndex="RepeatTimeSheetHandlerTypeName" />
                                                    ...
                                                    <ext:HeaderColumn AutoWidthElement="False">
                                                        <Component>
                                                            <ext:ComboBox runat="server"
                                                                ...
                                                                <Listeners>
                                                                    <Expand Handler="cbxSchedulerTimeSheetHandlerTypeFilter.store.reload();" />
                                                                    <Select Handler="
                                                                        this.triggers[0].show();
                                                                        reloadData();"></Select>
                                                                    <TriggerClick Handler="
                                                    ...
                                                    <ext:HeaderColumn AutoWidthElement="False">
                                                        <Component>
                                                            <ext:ComboBox runat="server"
                                                                ...
                                                                <Listeners>
                                                                    <Expand Handler="cbxSchedulerRepeatTimeSheetHandlerTypeFilter.store.reload();" />
                                                                    <Select Handler="
                                                                        this.triggers[0].show();
                                                                        reloadData();"></Select>
                                                                    <TriggerClick Handler="
                                    ...
                                    <ext:PagingToolbar runat="server"
                                        ...
                                        <Items>
                                            ...
                                            <ext:ComboBox runat="server" Width="80">
                                                ...
                                                <Listeners>
                                                    <Select Handler="#{pagingToolbar}.pageSize=parseInt(this.getValue());#{pagingToolbar}.doLoad();#{rowSelectionModel}.clearSelections();"></Select>
                                                </Listeners>
                                            </ext:ComboBox>
                                        </Items>
                                        <Listeners>
                            ...
                            <ext:Container runat="server" LabelAlign="left" Layout="FormLayout" LabelWidth="100" ColumnWidth="0.5">
                                <Items>
                                    <ext:ComboBox runat="server"
                                        ...
                                        TabIndex="3">
                                        <Listeners>
                                            <Expand Handler="if(#{cbxSchedulerTimeSheetHandlerType}.store.getCount()==0) {#{storeSchedulerTimeSheetHandlerType}.reload();}" />
                                            <Select Handler="#{hdfSchedulerTimeSheetHandlerType}.setValue(this.getValue());"></Select>
                                        </Listeners>
                                    </ext:ComboBox>
                                </Items>
                            </ext:Container>
                            <ext:Container runat="server" LabelAlign="left" Layout="FormLayout" LabelWidth="100" ColumnWidth="0.5">
                                <Items>
                                    <ext:ComboBox runat="server"
                                        ...
                                        TabIndex="4">
                                        <Listeners>
                                            <Expand Handler="if(#{cbxSchedulerRepeatTimeSheetHandlerType}.store.getCount()==0){#{storeSchedulerRepeatTimeSheetHandlerType}.reload();}" />
                                            <Select Handler="#{hdfSchedulerRepeatTimeSheetHandlerType}.setValue(this.getValue());"></Select>
                                        </Listeners>
                                    </ext:ComboBox>
                                </Items>
                            </ext:Container>
