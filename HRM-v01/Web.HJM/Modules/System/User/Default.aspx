<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.System.ModulesSystemUserDefault" Codebehind="Default.aspx.cs" %>

<%@ Register Src="~/Modules/ChooseEmployee/ucChooseEmployee.ascx" TagName="ucChooseEmployee" TagPrefix="uc2" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="/Modules/System/User/Resource/user.js"></script>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <!-- choose employee -->
        <uc2:ucChooseEmployee ID="ucChooseEmployee1" runat="server" ChiChonMotCanBo="false" DisplayWorkingStatus="TatCa" />
    </form>
</body>
</html>
