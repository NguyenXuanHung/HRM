<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RoleManagement.aspx.cs" Inherits="Web.HJM.Modules.System.RoleManagement" %>
                            ...
                            <ext:GridPanel runat="server" ID="gpRole" StoreID="roleStore" FireSelectOnLoad="true" Border="false" AutoExpandColumn="RoleName" Width="350" Title="Danh sách vai trò">
                                ...
                                <SelectionModel>
                                    <ext:RowSelectionModel runat="server" ID="rowSelectionModel" SingleSelect="True">
                                        <Listeners>
                                            <RowSelect Handler="handlerRoleChanged(rowSelectionModel.getSelected().get('Id'));" />
                                ...
                                <BottomBar>
                                    <ext:PagingToolbar runat="server" ID="pagingToolbar" PageSize="30" DisplayInfo="true" DisplayMsg="Từ {0} - {1} / {2}" EmptyMsg="Không có dữ liệu">
                                        <Listeners>
                                            <Change Handler="rowSelectionModel.clearSelections();btnEdit.disable();btnDelete.disable();btnSaveMenuRole.disable();toggleCheckbox(true);" />
                                        </Listeners>
                                    </ext:PagingToolbar>
                                </BottomBar>
                            </ext:GridPanel>
