<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.Salary.SalaryConfig" CodeBehind="SalaryConfig.aspx.cs" %>
...
<head id="Head1" runat="server">
    <title></title>
    <style type="text/css">
        div#gridSalaryConfig .x-grid3-cell-inner, .x-grid3-hd-inner {
    ...
    <script type="text/javascript">
        var keyPresstxtSearch = function (f, e) {
            if (e.getKey() === e.ENTER) {
                toolbarPaging.pageIndex = 0;
                toolbarPaging.doLoad();
        ...
        var checkInput = function () {
            ...
            if (txtColumnExcel.getValue() == '' || txtColumnExcel.getValue().trim == '') {
                            ...
                            <ext:GridPanel ID="gridSalaryConfig" TrackMouseOver="true" Title="Cấu hình chi tiết" runat="server" 
                                        ...
                                        <Items>
                                            ...
                                            <ext:TriggerField runat="server" ID="txtSearch" EnableKeyEvents="true" Width="250"
                                                ...
                                                <Listeners>
                                                    ...
                                                    <TriggerClick Handler="this.triggers[0].hide(); this.clear();#{toolbarPaging}.pageIndex = 0; #{toolbarPaging}.doLoad(); RowSelectionModel1.clearSelections();" />
                                                </Listeners>
                                            </ext:TriggerField>
                                            <ext:Button runat="server" ID="btnSearch" Text="Tìm kiếm" Icon="Zoom">
                                                <Listeners>
                                                    <Click Handler="#{toolbarPaging}.pageIndex = 0; #{toolbarPaging}.doLoad(); RowSelectionModel1.clearSelections();" />
                                                </Listeners>
                                            </ext:Button>
                                        </Items>
                                    </ext:Toolbar>
                                        ...
                                        <Reader>
                                            <ext:JsonReader IDProperty="Id" Root="Data" TotalProperty="TotalRecords">
                                                <Fields>
                                                    ...
                                                    <ext:RecordField Name="DataTimeSheetHandlerTypeName" />
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column Header="Loại dữ liệu" Width="150" Align="Left" DataIndex="DataTimeSheetHandlerTypeName" />
                                ...
                                <SelectionModel>
                                    <ext:RowSelectionModel runat="server" ID="RowSelectionModel1">
                                        <Listeners>
                                            <RowSelect Handler="hdfId.setValue(RowSelectionModel1.getSelected().id);" />
                                ...
                                <BottomBar>
                                    <ext:PagingToolbar runat="server" ID="toolbarPaging" PageSize="50" DisplayInfo="True" DisplayMsg="Từ {0} đến {1} / {2}" EmptyMsg="Không có dữ liệu">
                                        <Items>
                                            ...
                                            <ext:ComboBox runat="server" Width="80">
                                                ...
                                                <Listeners>
                                                    <Select Handler="#{toolbarPaging}.pageSize = parseInt(this.getValue()); #{toolbarPaging}.doLoad();"></Select>
                                                </Listeners>
                                            </ext:ComboBox>
                                        </Items>
                                    </ext:PagingToolbar>
                    ...
                    <ext:Container ID="Container7" runat="server" Layout="Form" Height="400">
                        <Items>
                            <ext:ComboBox ID="cbxDataType" runat="server" CtCls="requiredData" FieldLabel="Loại dữ liệu"
                                ...
                                <Listeners>
                                    <Select Handler="if(cbxDataTimeSheetHandlerType.getValue() == '1'){txtColumnCode.hide();cbxChoseFieldFixed.show();}else{txtColumnCode.show();cbxChoseFieldFixed.hide();hdfChoseFieldFixed.reset();cbxChoseFieldFixed.clearValue();}"></Select>
                                </Listeners>
                            </ext:ComboBox>
                            ...
                            <ext:ComboBox runat="server" ID="cbxChoseFieldFixed" FieldLabel="Mã cột" CtCls="requiredData" DisplayField="Name" ValueField="Name" Hidden="True"
                                LoadingText="Đang tải dữ liệu..." ItemSelector="div.list-item" AnchorHorizontal="98%" TabIndex="33" Editable="false" AllowBlank="false">
                                <Triggers>
                                    <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                </Triggers>
                                ...
                                <Listeners>
                                    <Select Handler="this.triggers[0].show();hdfChoseFieldFixed.setValue(cbxChoseFieldFixed.getValue());console.log(cbxChoseFieldFixed.getValue()); "></Select>
                            ...
                            <ext:TextField runat="server" ID="txtColumnExcel" FieldLabel="Cột Excel" AnchorHorizontal="98%" CtCls="requiredData"></ext:TextField>
