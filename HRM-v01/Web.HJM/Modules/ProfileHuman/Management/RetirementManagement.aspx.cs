...
namespace Web.HJM.Modules.ProfileHuman.Management
{
    public partial class RetirementManagement : BasePage
    {
        ...
        private void Update()
        {
            ...
            {
                var makerPosition = string.Empty;
                var curDepartment = string.Empty;
                ...
                if (hdfIsUpdateCurrentDepartment.Text == @"0")
                    curDepartment = cbxUpdateCurrentDepartment.Text;
                else
                    curDepartment = cbxUpdateCurrentDepartment.SelectedItem.Text;
