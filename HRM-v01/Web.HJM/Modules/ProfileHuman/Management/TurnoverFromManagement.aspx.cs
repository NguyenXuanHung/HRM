...
{
    public partial class TurnoverFromManagement : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!ExtNet.IsAjaxRequest)
            {
                ...
                if (btnEdit.Visible)
                {
                    gridTurnoverFrom.Listeners.RowDblClick.Handler +=
                        " if(CheckSelectedRows(gridTurnoverFrom)){btnUpdateAndSave.show();}";
                }
            }
        }
        ...
        protected void InsertOrUpdate(object sender, DirectEventArgs e)
        {
            ...
            if (e.ExtraParams["Close"] != "True")
            {
                ...
                gridTurnoverFrom.Reload();
                return;
            }

            //hide window
            wdTurnoverFrom.Hide();
            wdUpdateTurnoverFrom.Hide();
