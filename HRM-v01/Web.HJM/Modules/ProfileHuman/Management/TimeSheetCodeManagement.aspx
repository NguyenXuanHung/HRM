<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.ProfileHuman.Management.TimeSheetCodeManagement" Codebehind="TimeSheetCodeManagement.aspx.cs" %>
                    ...
                    <ext:Container ID="Container1" runat="server" Layout="Column" Height="400">
                        <Items>
                            <ext:Container ID="Container2" runat="server" LabelWidth="120" LabelAlign="left"
                                ...
                                <Items>
                                    <ext:TextField runat="server" ID="txtTimeSheetCode" CtCls="requiredData" FieldLabel="Mã chấm công<span style='color:red;'>*</span>"
                                        AnchorHorizontal="98%" />
                                    ...
                                    <ext:DateField ID="dfEndTime" runat="server" Vtype="daterange" FieldLabel="Thời gian kết thúc"
                                        AnchorHorizontal="98%" TabIndex="4" Editable="true" MaskRe="/[0-9\/]/" Format="d/M/yyyy">
                                        <CustomConfig>
                ...
                <Items>
                    <ext:Container runat="server" Layout="FormLayout" LabelWidth="150">
                        <Items>
                            ...
                            <ext:TextField runat="server" ID="txtFromRow" FieldLabel="Từ hàng" AnchorHorizontal="98%" MaskRe="/[0-9.]/" />
                            <ext:TextField runat="server" ID="txtToRow" FieldLabel="Đến hàng" AnchorHorizontal="98%" MaskRe="/[0-9.]/" />
                        </Items>
                    </ext:Container>
                </Items>
                <Buttons>
