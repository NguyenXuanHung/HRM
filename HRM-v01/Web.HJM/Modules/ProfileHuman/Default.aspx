<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HJM.Modules.ProfileHuman.Default" CodeBehind="Default.aspx.cs" %>

<%@ Register Src="EmployeeDetail.ascx" TagName="EmployeeDetail" TagPrefix="UC" %>
<%@ Register Src="UpdateImageEmployeeSeries.ascx" TagName="CapNhatAnhHangLoat" TagPrefix="uc2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title></title>
    <link type="text/css" href="Resource/HumanRecord.css" rel="stylesheet" />
    <script type="text/javascript" src="/Resource/js/jquery-3.2.1.min.js"></script>
    <script type="text/javascript" src="/Resource/js/global.js"></script>
    <script type="text/javascript" src="Resource/HumanRecord.js"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Menu ID="RowContextMenu" runat="server">
            <Items>
                <ext:MenuItem ID="mnuAdd" runat="server" Icon="Add" Text="Thêm mới">
                    <Listeners>
                        <Click Handler="wdInput.show();" />
                    </Listeners>
                </ext:MenuItem>
                <ext:MenuItem ID="mnuEdit" runat="server" Icon="Pencil" Text="Sửa">
                    <Listeners>
                        <Click Handler="#{hdfEven}.setValue('Edit');if(CheckSelectedRecord(#{grp_HoSoNhanSu}, #{store_HoSoNhanSu})){wdInput.show();}else{return false;}" />
                    </Listeners>
                </ext:MenuItem>
        ...
        <ext:Window Modal="true" Hidden="true" runat="server" Layout="BorderLayout" ID="wdInput"
            Title="Cập nhật thông tin CBCC" Maximized="true" CtCls="HideHeader">
            <Items>
                <ext:TabPanel ID="TabPanel1" Region="Center" AnchorVertical="100%" Border="false" runat="server">
                </ext:TabPanel>
            </Items>
            <Listeners>
                <Hide Handler="store_HoSoNhanSu.reload();" />
                <BeforeShow Handler="TabPanel1.remove(0); addHomePage(TabPanel1, 'Homepage', '../ProfileHuman/EmployeeSetting.aspx?Event='+hdfEven.getValue()+'&MenuID='+hdfMenuID.getValue()+'&PrKeyHoSo='+hdfRecordId.getValue(), 'Cập nhật ');" />
            </Listeners>
            <Buttons>
        ...
        <ext:Window runat="server" Title="<%$ Resources:HOSO, Select_Image%>" Resizable="false"
            Icon="ImageAdd" Hidden="true" Padding="6" ID="wdUploadImageWindow" Width="400" Modal="true" AutoHeight="true">
            <Items>
        ...
        <ext:Window runat="server" Title="Nhập dữ liệu từ file excel" Resizable="true" Layout="FormLayout"
            ...
            <Items>
                ...
                <ext:GridPanel ID="grpImportExcel" runat="server" AnchorHorizontal="100%" Height="270" Hidden="True"
        ...
        <!-- store HoSoNhanSu -->
        <ext:Store ID="store_HoSoNhanSu" AutoLoad="false" runat="server">
            <Proxy>
                <ext:HttpProxy Method="POST" Url="~/Services/HandlerRecord.ashx" />
            </Proxy>
            <AutoLoadParams>
                        ...
                        <ext:GridPanel runat="server" ID="grp_HoSoNhanSu" StoreID="store_HoSoNhanSu" Border="false" StripeRows="True" TrackMouseOver="true" AnchorHorizontal="100%"
                                ...
                                <ext:Toolbar runat="server" ID="toolbarFn">
                                    <Items>
                                        <ext:Button ID="btnAddNew" runat="server" Text="Thêm mới" Icon="Add">
                                            <Listeners>
                                                <Click Handler="#{hdfEven}.setValue('Insert');wdInput.show();" />
                                            </Listeners>
                                        </ext:Button>
                                        ...
                                        <ext:Button ID="btnDelete" runat="server" Text="Xóa" Disabled="true" Icon="Delete">
                                            <Listeners>
                                                <Click Handler="if (hdfRecordId.getValue() == '') {alert ('Bạn chưa chọn bản ghi nào'); return false;}" />
                                            </Listeners>
                                            <DirectEvents>
                                                ...
                                                <ext:Menu ID="Menu1" runat="server">
                                                    <Items>
                                                        ...
                                                        <ext:MenuItem runat="server" ID="mnuInfoRecord" Text="1. Sơ yếu lý lịch (2C - 32)" Icon="PrinterGo">
                                                            <Listeners>
                                                                <Click Handler="if (CheckSelectedRecord(#{grp_HoSoNhanSu}, #{store_HoSoNhanSu}) == false) {return;} else {#{hdfTimeSheetHandlerTypeReport}.setValue('RecordDetail'); wdShowReport.show();}" />
                                                            </Listeners>
                                                        </ext:MenuItem>
                                                        <ext:MenuItem runat="server" ID="mnuRecordNew" Text="2. Sơ yếu lý lịch (2C - 1998)" Icon="PrinterGo">
                                                            <Listeners>
                                                                <Click Handler="if (CheckSelectedRecord(#{grp_HoSoNhanSu}, #{store_HoSoNhanSu}) == false) {return;} else {#{hdfTimeSheetHandlerTypeReport}.setValue('RecordDetailV2'); wdShowReport.show();}" />
                                                            </Listeners>
                                                        </ext:MenuItem>
                                                    </Items>
                                                </ext:Menu>
                                                ...
                                                <ext:HeaderColumn AutoWidthElement="false">
                                                    <Component>
                                                        <ext:ComboBox ID="filterRecruimentDate" Width="120" runat="server" Editable="false" DisplayField="TEN"
                                                            ValueField="MA">
                                                            <Store>
                                                                <ext:Store runat="server" ID="filterRecruimentDateStore" AutoLoad="False" OnRefreshData="filterRecruimentDateStore_Store_OnRefreshData">
                                                                    <Reader>
                                                            ...
                                                            <Listeners>
                                                                <Expand Handler="filterRecruimentDateStore.reload();" />
                                                                <Select Handler="#{DirectMethods}.SetValueQuery();
                            ...
                            <ColumnModel ID="ColumnModel1" runat="server">
                                <Columns>
                                    ...
                                    <ext:Column ColumnID="RecruimentDate" Width="120" Header="Ngày tuyển dụng" DataIndex="RecruimentDate" />
                                ...
                                <ext:RowSelectionModel runat="server" ID="rowSelection">
                                    <Listeners>
                                        <RowSelect Handler="hdfRecordId.setValue(rowSelection.getSelected().id);
                                                        ...
                                                        Ext.net.DirectMethods.GetEmployeeDetailInformation();
                            ...
                            <BottomBar>
                                <ext:PagingToolbar ID="PagingToolbar1" EmptyMsg="<%$ Resources:HOSO, no_data%>" NextText="<%$ Resources:HOSO, next_page%>"
                                    PageSize="12" PrevText="<%$ Resources:HOSO, prev_page%>" LastText="<%$ Resources:HOSO, last_page%>"
                                    FirstText="<%$ Resources:HOSO, first_page%>" DisplayMsg="<%$ Resources:HOSO, description_record%>" runat="server">
                                    <Items>
