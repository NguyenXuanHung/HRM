...
/// <summary>
/// Summary description for rp_BusinessCommunityPartyVietnamMember
/// </summary>
public class rp_BusinessCommunityPartyVietnamMember : XtraReport
{
    ...
    public rp_BusinessCommunityPartyVietnamMember()
    {
        InitializeComponent();
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            // select form db 
            var table = SQLHelper.ExecuteTable(SQLBusinessAdapter.GetStore_CommunistPart(string.Join(",", arrDepartment), fromDate, toDate));
            DataSource = table;
    ...
    {
            string resourceFileName = "rp_BusinessCommunityPartyVietnamMember.resx";
            ...
            this.xrl_TitleReport.Text = "DANH SÁCH ĐẢNG VIÊN TRONG CÔNG TY";
