...
/// <summary>
/// Summary description for rp_BusinessDecreaseInsurance
/// </summary>
public class rp_BusinessDecreaseInsurance : XtraReport
{
    ...
    public rp_BusinessDecreaseInsurance()
    {
        InitializeComponent();
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            // select form db 
            var table = SQLHelper.ExecuteTable(SQLBusinessAdapter.GetStore_IncreaseDecreaseInsurance(string.Join(",", arrDepartment), null, true,fromDate,toDate));
            DataSource = table;
    ...
    {
            string resourceFileName = "rp_BusinessDecreaseInsurance.resx";
            ...
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTable4.LocationFloat = new DevExpress.Utils.PointFloat(0.0002066294F, 0F);
            ...
            this.xrTableCell8.Text = "Cộng giảm";
