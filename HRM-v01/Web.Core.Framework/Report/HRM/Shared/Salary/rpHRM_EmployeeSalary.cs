...
namespace Web.Core.Framework.Report
{
    ...
    /// Summary description for rpHRM_EmployeeSalary
    /// </summary>
    public class rpHRM_EmployeeSalary : XtraReport, IBaseReport
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportSalaryAdapter.GetStore_EmployeeSalary(string.Join(",", _filter.Departments.Split(
                    new[] { "," }, StringSplitOptions.RemoveEmptyEntries).Select(d => "{0}".FormatWith(d))), fromDate, toDate, _filter.Condition, _filter.RecordIds));
                DataSource = table;
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "DANH SÁCH TIỀN LƯƠNG CBCNV CÔNG TY";
            ...
            this.lblReportDate.LocationFloat = new DevExpress.Utils.PointFloat(569.0577F, 23.00001F);
