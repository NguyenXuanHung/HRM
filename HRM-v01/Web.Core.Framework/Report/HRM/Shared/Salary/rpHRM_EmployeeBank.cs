...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHRM_EmployeeBank : XtraReport, IBaseReport
    {
        ...
        private XRTableCell xrCellAccount;
        private XRTableCell xrTableCell11;
        private XRTableCell xrCellBranch;
        ...
        public void BindData()
        {
            ...
            {                
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportSalaryAdapter.GetStore_EmployeeBank(string.Join(",", _filter.Departments.Split(
                ...
                xrCellAccount.DataBindings.Add("Text", DataSource, "AccountNumber");
                xrCellBranch.DataBindings.Add("Text", DataSource, "BankName");
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "SỐ TÀI KHOẢN CBCNV CÔNG TY";
            ...
            this.lblReportDate.LocationFloat = new DevExpress.Utils.PointFloat(363.6411F, 18.99999F);
            this.lblReportDate.Name = "lblReportDate";
            this.lblReportDate.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.lblReportDate.SizeF = new System.Drawing.SizeF(430.3589F, 23F);
