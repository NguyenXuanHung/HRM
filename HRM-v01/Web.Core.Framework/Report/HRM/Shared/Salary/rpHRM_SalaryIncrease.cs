...
{
    /// <summary>
    /// Summary description for rpHRM_SalaryIncrease
    /// </summary>
    public class rpHRM_SalaryIncrease : XtraReport, IBaseReport
    {
        ...
        private XRTableCell xrTableCellThoiHanNangLuong;
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var departmentIds = string.Join(",", _filter.Departments.Split(new[] {","}, StringSplitOptions.RemoveEmptyEntries).Select(d => "'{0}'".FormatWith(d)));

                var table = SQLHelper.ExecuteTable(SQLManagementAdapter.GetStore_ListSalaryRaise(departmentIds, fromDate, toDate, null, null, (int)SalaryDecisionType.Regular, _filter.Condition, null));
                DataSource = table;
                ...
                xrTableCellBacNgach.DataBindings.Add("Text", DataSource, "QuantumGrade");
                ...
                xrTableCellThoiHanNangLuong.DataBindings.Add("Text", DataSource, "RaisingSalaryDate", "{0:dd/MM/yyyy}");
        ...
        private void InitializeComponent()
        {
            ...
            this.xrTableCellThoiHanNangLuong = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTableCellThoiHanNangLuong});
            ...
            // 
            // xrTableCellThoiHanNangLuong
            // 
            this.xrTableCellThoiHanNangLuong.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellThoiHanNangLuong.Name = "xrTableCellThoiHanNangLuong";
            this.xrTableCellThoiHanNangLuong.StylePriority.UseBorders = false;
            this.xrTableCellThoiHanNangLuong.StylePriority.UseTextAlignment = false;
            this.xrTableCellThoiHanNangLuong.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellThoiHanNangLuong.Weight = 0.30849112169073462D;
            // 
            // TopMargin
            // 
            ...
            this.xrTenCoQuanCapTren.Text = "TÊN CƠ QUAN CẤP TRÊN (nếu có)";
            ...
            this.lblReportTitle.Text = "BÁO CÁO DANH SÁCH CÁN BỘ ĐẾN KỲ NÂNG LƯƠNG";
            ...
            this.xrTableCell3.Text = "Thời hạn nâng lương";
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(863.7072F, 115.8618F);
            ...
            this.lblReviewedByName.LocationFloat = new DevExpress.Utils.PointFloat(423.6537F, 112.7368F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(24.38418F, 115.8618F);
