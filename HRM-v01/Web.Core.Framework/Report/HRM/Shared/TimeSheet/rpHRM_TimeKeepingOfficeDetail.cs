...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHRM_TimeKeepingOfficeDetail : XtraReport, IBaseReport
    {
        ...
        public rpHRM_TimeKeepingOfficeDetail()
        {
            InitializeComponent();
            // init Filter
            InitFilter();
        ...
        public void BindData()
        {
            ...
            if (timeSheetReport != null)
            {
                ...
                if (timeSheetReport.EndDate != null) endDate = timeSheetReport.EndDate.Value;
                    ...
                    var records =
                        TimeSheetEmployeeReportController.GetAll(null, null, null, _filter.TimeSheetReportId, null,
                            null);
                    if (records.Count > 0)
                    {
