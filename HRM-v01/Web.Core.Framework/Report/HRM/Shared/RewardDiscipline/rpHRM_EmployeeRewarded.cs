...
{
    /// <summary>
    /// Summary description for rp_CCVC_BaoCaoDanhSachCanBoDuocKhenThuong
    /// </summary>
    public class rpHRM_EmployeeRewarded : XtraReport, IBaseReport
    {
        ...
        private void InitFilter()
        {
            ...
            // filter reward 
            _filter.Items.Add(FilterGenerate.RewardFilter());
        }

        /// <summary>
        /// Default constructor
        /// </summary>
        public rpHRM_EmployeeRewarded()
        {
            // init compoent
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.xrToDate.Text = "Từ ngày {0} đến ngày {1}";
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(876.2927F, 111.6477F);
            ...
            this.lblReviewedByName.LocationFloat = new DevExpress.Utils.PointFloat(439.5844F, 112.1667F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(24.38431F, 111.6477F);
