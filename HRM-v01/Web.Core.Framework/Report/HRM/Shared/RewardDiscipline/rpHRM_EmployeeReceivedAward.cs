...
{
    /// <summary>
    /// Summary description for rpHRM_EmployeeReceivedAward
    /// </summary>
    public class rpHRM_EmployeeReceivedAward : XtraReport, IBaseReport
    {
        ...
        private XRTableCell xrCellAwardDate;
        ...
        /// Default constructor
        /// </summary>
        public rpHRM_EmployeeReceivedAward()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            ...
            {                
                ...
                xrCellContent.DataBindings.Add("Text", DataSource, "EmulationTitle");
                xrCellAwardDate.DataBindings.Add("Text", DataSource, "DecisionDate", "{0:dd/MM/yyyy}");
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "DANH SÁCH CBCNV ĐƯỢC TẶNG DANH HIỆU THI ĐUA";
            ...
            this.lblReportDate.LocationFloat = new DevExpress.Utils.PointFloat(639.5073F, 33.54167F);
            this.lblReportDate.Name = "lblReportDate";
            this.lblReportDate.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.lblReportDate.SizeF = new System.Drawing.SizeF(409.5256F, 23F);
