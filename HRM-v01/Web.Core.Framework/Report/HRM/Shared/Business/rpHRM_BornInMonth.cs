...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHRM_BornInMonth : XtraReport, IBaseReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "BÁO CÁO CBCNV SINH NHẬT TRONG THÁNG {0}";
            ...
            this.lblReportDate.LocationFloat = new DevExpress.Utils.PointFloat(547.7083F, 19.54167F);
