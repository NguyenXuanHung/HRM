...
{
    /// <summary>
    /// Summary description for rpHRM_Occupation
    /// </summary>
    public class rpHRM_OccupationStatistics : XtraReport, IBaseReport
    {
        ...
        /// Default constructor
        /// </summary>
        public rpHRM_OccupationStatistics()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_StatisticOccupation(string.Join(",", _filter.Departments.Split(
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "DANH SÁCH THỐNG KÊ NGHỀ NGHIỆP";
