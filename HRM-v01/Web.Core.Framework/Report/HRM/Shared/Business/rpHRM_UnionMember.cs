...
{
    /// <summary>
    /// Summary description for rpHRM_UnionMember
    /// </summary>
    public class rpHRM_UnionMember : XtraReport, IBaseReport
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_UnionMember(string.Join(",", _filter.Departments.Split(
