...
{
    /// <summary>
    /// Summary description for rpHRM_EmployeeTrainee
    /// </summary>
    public class rpHRM_EmployeeTrainee : XtraReport, IBaseReport
    {
        ...
        private XRTableCell xrCellStartTraining;
        private XRTableCell xrCellEndTraining;
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_EmployeeTrainee(string.Join(",", _filter.Departments.Split(
                ...
                xrCellStartTraining.DataBindings.Add("Text", DataSource, "ProbationDate", "{0:dd/MM/yyyy}");
                xrCellEndTraining.DataBindings.Add("Text", DataSource, "ProbationEndDate", "{0:dd/MM/yyyy}");
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "BÁO CÁO NHÂN SỰ ĐANG TRONG THỜI GIAN THỬ VIỆC";
            ...
            this.lblReportDate.LocationFloat = new DevExpress.Utils.PointFloat(576.0579F, 40.54165F);
