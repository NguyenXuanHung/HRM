...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHRM_MilitaryList : XtraReport, IBaseReport
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_MilitaryList(string.Join(",", _filter.Departments.Split(
