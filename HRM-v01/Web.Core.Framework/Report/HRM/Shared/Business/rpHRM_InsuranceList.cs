...
{
    /// <summary>
    /// Summary description for rpHRM_InsuranceList
    /// </summary>
    public class rpHRM_InsuranceList : XtraReport, IBaseReport
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_InsuranceList(string.Join(",", _filter.Departments.Split(
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "DANH SÁCH ĐÓNG BẢO HIỂM XÃ HỘI";
