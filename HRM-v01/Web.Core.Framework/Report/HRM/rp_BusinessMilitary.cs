...
/// </summary>
public class rp_BusinessMilitary : XtraReport
{
    ...
    private XRTableCell xrCellRank;
    ...
    private XRTableCell xrCellJoinArmyDate;
    private XRTableCell xrTableCell6;
    private XRTableCell xrTableCell11;
    private XRTableCell xrTableCell16;
    private XRTableCell xrCellLeaveArmyDate;
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            // select form db 
            var table = SQLHelper.ExecuteTable(SQLBusinessAdapter.GetStore_EmployeeArmy(string.Join(",", arrDepartment),fromDate,toDate));
            DataSource = table;

            //binding data
            xrCellEmployeeCode.DataBindings.Add("Text", DataSource, "EmployeeCode");
            xrCellFullName.DataBindings.Add("Text", DataSource, "FullName");
            xrCellJoinArmyDate.DataBindings.Add("Text", DataSource, "ArmyJoinedDate", "{0:dd/MM/yyyy}");
            xrCellPoliticLevel.DataBindings.Add("Text", DataSource, "PoliticLevelName");
            xrCellLeaveArmyDate.DataBindings.Add("Text", DataSource, "ArmyLeftDate", "{0:dd/MM/yyyy}");
            ...
            xrCellRank.DataBindings.Add("Text", DataSource, "ArmyLevelName");
    ...
    {
            string resourceFileName = "rp_BusinessMilitary.resx";
            ...
            this.xrl_TitleReport.Text = "DANH SÁCH CBCNV TỪNG LÀ QUÂN NHÂN";
