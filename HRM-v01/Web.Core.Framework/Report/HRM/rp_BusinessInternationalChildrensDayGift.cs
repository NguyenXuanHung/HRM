...
/// </summary>
public class rp_BusinessInternationalChildrensDayGift : XtraReport
{
    ...
    public rp_BusinessInternationalChildrensDayGift()
    {
        InitializeComponent();
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            lblTitle.Text = string.Format(lblTitle.Text, reportDate.Year);
            ...
            else
            {
                ...
                lblSubTitle.Text = string.Format(lblSubTitle.Text, orgSelected.Name);
            }

            var table = SQLHelper.ExecuteTable(
                SQLBusinessAdapter.GetStore_BusinessInternationalChildrensDayGift(string.Join(",", arrDepartment),
                    filter.WhereClause));
            DataSource = table;
    ...
    {
            string resourceFileName = "rp_BusinessInternationalChildrensDayGift.resx";
            ...
            this.lblTitle.Text = "DANH SÁCH CÁC CON ĐƯỢC TẶNG QUÀ 01/06/{0}";
            ...
            // 
            // rp_BusinessInternationalChildrensDayGift
            // 
