...
/// </summary>
public class rp_BusinessAppointment : XtraReport
{
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessAdapter.GetStore_EmployeeAppointment(string.Join(",", arrDepartment),fromDate,toDate,
                    filter.WhereClause));
            DataSource = table;
    ...
    {
            string resourceFileName = "rp_BusinessAppointment.resx";
            ...
            this.lblTitle.Text = "BÁO CÁO CBCNV ĐƯỢC BỔ NHIỆM";
