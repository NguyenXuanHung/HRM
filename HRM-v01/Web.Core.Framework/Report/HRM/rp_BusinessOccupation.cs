...
/// </summary>
public class rp_BusinessOccupation : XtraReport
{
    ...
    private XRTableCell xrCellOccupation;
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessAdapter.GetStore_StatisticOccupation(string.Join(",", arrDepartment), fromDate, toDate, filter.WhereClause));
            DataSource = table;
            ...
            xrCellWorkingDate.DataBindings.Add("Text", DataSource, "WorkDate", "{0:dd/MM/yyyy}");
            xrCellOccupation.DataBindings.Add("Text", DataSource, "Occupation");
