...
{
    /// <summary>
    /// Summary description for rp_ProcessSalaryEmployee
    /// </summary>
    public class rp_ProcessSalaryEmployee : XtraReport
    {
        ...
        public rp_ProcessSalaryEmployee()
        {
            InitializeComponent();
            //
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                var table = SQLHelper.ExecuteTable(
                    SQLManagementSalaryAdapter.GetStore_ProcessSalaryOfEmployee(string.Join(",", arrDepartment),
                        filter.RecordId, filter.WhereClause));
        ...
        {
            string resourceFileName = "rp_ProcessSalaryEmployee.resx";
            ...
            this.xrLabel7.Text = "BÁO CÁO DIỄN BIẾN QUÁ TRÌNH LƯƠNG CỦA CÁN BỘ";
