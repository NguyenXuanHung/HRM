...
/// </summary>
public class rp_BusinessOnsiteTraining : XtraReport
{
    ...
    private XRTableCell xrCellSpecialist;
    ...
    private XRTableCell xrCellEndDate;
    ...
    public rp_BusinessOnsiteTraining()
    {
        InitializeComponent();
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessTrainingAdapter.GetStore_BusinessOnsiteTraining(string.Join(",", arrDepartment),
            ...
            xrCellSpecialist.DataBindings.Add("Text", DataSource, "IndustryName");
            xrCellDepartment.DataBindings.Add("Text", DataSource, "DepartmentName");
            xrCellStartDate.DataBindings.Add("Text", DataSource, "StartDate", "{0:dd/MM/yyyy}");
            xrCellEndDate.DataBindings.Add("Text", DataSource, "EndDate", "{0:dd/MM/yyyy}");
    ...
    {
        string resourceFileName = "rp_BusinessOnsiteTraining.resx";
        ...
        this.xrl_TitleReport.Text = "DANH SÁCH CBCNV ĐƯỢC CỬ ĐI ĐÀO TẠO";
