...
/// </summary>
public class rp_DecreaseRegistrationOfLaborUtilization : XtraReport
{
    ...
    public rp_DecreaseRegistrationOfLaborUtilization()
    {
        InitializeComponent();
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessAdapter.GetStore_DecreaseRegistrationLabor(string.Join(",", arrDepartment), fromDate, toDate,
                    filter.WhereClause));
            DataSource = table;
    ...
    {
            string resourceFileName = "rp_DecreaseRegistrationOfLaborUtilization.resx";
            ...
            this.xrCellTotal.Weight = 0.41161583754931513D;
            this.xrCellTotal.BeforePrint += new System.Drawing.Printing.PrintEventHandler(this.Detail_BeforePrint);
            // 
            // xrCellFemale
            // 
            ...
            this.xrl_TitleReport.Text = "KHAI TRÌNH LAO ĐỘNG";
            ...
            this.xrl_footer3.LocationFloat = new DevExpress.Utils.PointFloat(576.0577F, 86.54169F);
            ...
            this.xrl_footer1.LocationFloat = new DevExpress.Utils.PointFloat(0F, 86.54169F);
            ...
            // 
            // rp_DecreaseRegistrationOfLaborUtilization
            // 
