...
/// </summary>
public class rp_BusinessExpiredContract : XtraReport
{
    ...
    public rp_BusinessExpiredContract()
    {
        InitializeComponent();
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessAdapter.GetStore_ExpiredContract(string.Join(",", arrDepartment), filter.WhereClause,fromDate,toDate));
            DataSource = table;
    ...
    {
            string resourceFileName = "rp_BusinessExpiredContract.resx";
            ...
            this.lblTitle.Text = "BÁO CÁO CBCNV HẾT HẠN HỢP ĐỒNG LAO ĐỘNG";
