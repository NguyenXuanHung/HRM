...
/// </summary>
public class rp_BusinessFemale : XtraReport
{
    ...
    {
            string resourceFileName = "rp_BusinessFemale.resx";
            ...
            this.lblTitle.Text = "DANH SÁCH CÁN BỘ CÔNG NHÂN VIÊN NỮ";
