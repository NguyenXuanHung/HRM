...
/// </summary>
public class rp_BusinessFamilyRelation : XtraReport
{
    ...
    public rp_BusinessFamilyRelation()
    {
        InitializeComponent();
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessSalaryAdapter.GetStore_BusinessFamilyRelation(string.Join(",", arrDepartment),
    ...
    {
        string resourceFileName = "rp_BusinessFamilyRelation.resx";
        ...
        this.lblTitle.Text = "DANH SÁCH NGƯỜI PHỤ THUỘC CBCNV CÔNG TY";
