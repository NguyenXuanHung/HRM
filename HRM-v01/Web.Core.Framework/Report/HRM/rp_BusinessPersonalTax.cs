...
/// </summary>
public class rp_BusinessPersonalTax : XtraReport
{
    ...
    private void InitializeComponent()
    {
            ...
            this.lblTitle.Text = "DANH SÁCH MÃ SỐ THUẾ CBCNV CÔNG TY";
