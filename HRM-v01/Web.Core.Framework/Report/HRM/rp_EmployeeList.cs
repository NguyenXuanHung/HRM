...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rp_AllEmployees : XtraReport
    {
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                // select form db               
                var departments = filter.LoginDepartment;
                var table = SQLHelper.ExecuteTable(SQLManagementAdapter.GetStore_DanhSachCanBoCCVCToanCoQuan());
                DataSource = table;
        ...
        {
            string resourceFileName = "rp_AllEmployees.resx";
            ...
            this.xrLabel7.Text = "BÁO CÁO DANH SÁCH CÁN BỘ, CÔNG CHỨC, VIÊN CHỨC TOÀN CƠ QUAN ";
