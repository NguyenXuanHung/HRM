...
/// </summary>
public class rp_BusinessBankAccount : XtraReport
{
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessSalaryAdapter.GetStore_BusinessBankAccount(string.Join(",", arrDepartment),
