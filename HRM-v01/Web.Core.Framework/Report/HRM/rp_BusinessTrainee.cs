...
/// </summary>
public class rp_BusinessTrainee : XtraReport
{
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessAdapter.GetStore_EmployeeProbation(string.Join(",", arrDepartment), filter.WhereClause,fromDate,toDate));
            DataSource = table;
