...
/// <summary>
/// Summary description for rp_BusinessVietnamYoungUnionMember
/// </summary>
public class rp_BusinessVietnamYoungUnionMember : XtraReport
{
    ...
    private XRTableCell xrCellVYUJoinDate;
    ...
    public rp_BusinessVietnamYoungUnionMember()
    {
        InitializeComponent();
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            // select form db 
            var table = SQLHelper.ExecuteTable(SQLBusinessAdapter.GetStore_VietNamYoungUnionJoined(string.Join(",", arrDepartment),fromDate,toDate));
            DataSource = table;

            //binding data
            xrCellEmployeeCode.DataBindings.Add("Text", DataSource, "EmployeeCode");
            xrCellFullName.DataBindings.Add("Text", DataSource, "FullName");
            xrCellSalary.DataBindings.Add("Text", DataSource, "SalaryInsurance", "{0:#,###}");
            xrCellJobTitle.DataBindings.Add("Text", DataSource, "JobTitleName");
            xrCellPosition.DataBindings.Add("Text", DataSource, "PositionName");
            xrCellVYUJoinDate.DataBindings.Add("Text", DataSource, "VYUJoinedDate", "{0:dd/MM/yyyy}");
    ...
    {
            string resourceFileName = "rp_BusinessVietnamYoungUnionMember.resx";
            ...
            this.xrl_TitleReport.Text = "DANH SÁCH ĐOÀN VIÊN TRONG CÔNG TY";
            ...
            // 
            // rp_BusinessVietnamYoungUnionMember
            // 
