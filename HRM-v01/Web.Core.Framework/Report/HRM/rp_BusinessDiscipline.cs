...
/// </summary>
public class rp_BusinessDiscipline : XtraReport
{
    ...
    public void BindData(ReportFilter filter)
    {
        try
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLBusinessAwardnDisciplineAdapter.GetStore_BusinessDiscipline(string.Join(",", arrDepartment), 
    ...
    {
        string resourceFileName = "rp_BusinessDiscipline.resx";
        ...
        this.xrl_TitleReport.Text = "DANH SÁCH CBCNV BỊ KỶ LUẬT";
