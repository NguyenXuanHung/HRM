...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rp_SalaryDistrictCivilServants : XtraReport
    {
        ...
        public rp_SalaryDistrictCivilServants()
        {
            InitializeComponent();
            //
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                var table = SQLHelper.ExecuteTable(
                    SQLReportAdapter.GetStore_DanhSachTienLuongCNCCCapHuyen(string.Join(",", arrOrgCode),
                        filter.WhereClause));
        ...
        {
            string resourceFileName = "rp_SalaryDistrictCivilServants.resx";
            ...
            this.xrCellReportName.Text = "BÁO CÁO DANH SÁCH VÀ TIỀN LƯƠNG CÔNG CHỨC TỪ CẤP HUYỆN TRỞ LÊN NĂM {0}";
    ...
    "i vụ";
            ...
            // 
            // rp_SalaryDistrictCivilServants
            // 
