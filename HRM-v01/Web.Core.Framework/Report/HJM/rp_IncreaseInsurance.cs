...
{
    /// <summary>
    /// Summary description for rp_IncreaseInsurance
    /// </summary>
    public class rp_IncreaseInsurance : XtraReport
    {
            ...
            try
            {
                ...
                var table = SQLHelper.ExecuteTable(
                    SQLManagementAdapter.GetStore_BaoCaoTangGiamBh(
                        string.Join(",", arrDepartment), filter.WhereClause, null, false, null, null, null));
                DataSource = table;
                ...
                xrTableCellTotalMucDongBH.DataBindings.Add("Text", DataSource, "xSalaryInsuranceIn");
                xrTableCellTotalBHPhaiNop.DataBindings.Add("Text", DataSource, "xInsuranceSubmitIn");
            }
            catch
            {
            }
        ...
        {
            string resourceFileName = "rp_IncreaseInsurance.resx";
            ...
            this.xrTitle.Text = "BÁO CÁO TĂNG THAM GIA BHXH, BHYT, BHTN";
            ...
            this.xrTableCell22.Text = "LÝ DO TĂNG";
