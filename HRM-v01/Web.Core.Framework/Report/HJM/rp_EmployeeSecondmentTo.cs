...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rp_EmployeeSecondmentTo : XtraReport
    {
        ...
        public rp_EmployeeSecondmentTo()
        {
            InitializeComponent();
        }
        int _stt = 1;
        ...
        {
            string resourceFileName = "rp_EmployeeSecondmentTo.resx";
            ...
            this.xrTableCell20.Text = "BÁO CÁO DANH SÁCH CÁN BỘ ĐƯỢC BIỆT PHÁI ĐẾN";
