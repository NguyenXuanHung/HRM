...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rp_EmployeeTurnoverFrom : XtraReport
    {
        ...
        public rp_EmployeeTurnoverFrom()
        {
            InitializeComponent();
        }
        int STT = 1;
        ...
        {
            string resourceFileName = "rp_EmployeeTurnoverFrom.resx";
            ...
            this.xrTableCell20.Text = "BÁO CÁO DANH SÁCH CÁN BỘ ĐƯỢC LUẤN CHUYỂN ĐI";
