...
{
    /// <summary>
    /// Summary description for rp_CCVC_BaoCaoDanhSachCanBoDuocTangDanhHieuThiDua
    /// </summary>
    public class rp_EmployeeEmulationTitle : XtraReport
    {
        ...
        public rp_EmployeeEmulationTitle()
        {
            InitializeComponent();
        }
        int _stt;
        ...
        {
            string resourceFileName = "rp_EmployeeEmulationTitle.resx";
            ...
            this.xrTableCell20.Text = "BÁO CÁO DANH SÁCH CÁN BỘ ĐƯỢC TẶNG DANH HIỆU THI ĐUA";
