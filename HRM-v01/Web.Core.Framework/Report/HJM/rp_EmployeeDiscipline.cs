...
{
    /// <summary>
    /// Summary description for rp_CCVC_BaoCaoDanhSachCanBoBiKyLuat
    /// </summary>
    public class rp_EmployeeDiscipline : XtraReport
    {
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                var table = SQLHelper.ExecuteTable(
                    SQLManagementRewardDisciplineAdapter.GetStore_DanhSachCanBoBiKyLuat(string.Join(",", arrDepartment),
                        filter.WhereClause));
                DataSource = table;
        ...
        {
            string resourceFileName = "rp_EmployeeDiscipline.resx";
            ...
            this.xrTenCoQuanDonVi.Font = new System.Drawing.Font("Times New Roman", 6F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(1)), true);
            ...
            this.xrTitle.Text = "BÁO CÁO DANH SÁCH CÁN BỘ BỊ KỶ LUẬT";
