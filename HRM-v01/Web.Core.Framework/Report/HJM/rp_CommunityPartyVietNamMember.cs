...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rp_CommunityPartyVietNamMember : XtraReport
    {
        ...
        public rp_CommunityPartyVietNamMember()
        {
            InitializeComponent();
        }
        int _stt;
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                var result = RecordController.GetEmployeeIsCommunityPartyOfVietNam(departments, condition, null, start, pageSize);
        ...
        {
            string resourceFileName = "rp_CommunityPartyVietNamMember.resx";
            ...
            this.xrTableCell20.Text = "BÁO CÁO DANH SÁCH CÁN BỘ LÀ ĐẢNG VIÊN";
            ...
            // 
            // rp_CommunityPartyVietNamMember
            // 
