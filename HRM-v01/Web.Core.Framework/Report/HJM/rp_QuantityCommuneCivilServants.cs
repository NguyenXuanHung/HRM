...
{
    /// <summary>
    /// Summary description for rp_CCVC_BaoCaoSoLuongChatLuongCCTrongCoQuanToChucHanhChinh
    /// </summary>
    public class rp_QuantityCommuneCivilServants : XtraReport
    {
        ...
        public rp_QuantityCommuneCivilServants()
        {
            InitializeComponent();
            //
        ...
        public void BindData(ReportFilter filter)
        {
            ...
            var table = SQLHelper.ExecuteTable(
                SQLReportAdapter.GetStore_SoLuongChatLuongCBCCCapXa(filter.WhereClause), new[] {"@MaDonVi"},
        ...
        {
            string resourceFileName = "rp_QuantityCommuneCivilServants.resx";
            ...
            this.xrCellReportName.Text = "BÁO CÁO SỐ LƯỢNG, CHẤT LƯỢNG CÁN BỘ, CÔNG CHỨC CẤP XÃ NĂM {0}";
    ...
    "i vụ";
            ...
            // 
            // rp_QuantityCommuneCivilServants
            // 
