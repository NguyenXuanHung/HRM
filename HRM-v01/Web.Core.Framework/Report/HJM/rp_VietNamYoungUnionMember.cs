...
{
    /// <summary>
    /// Summary description for rp_VietNamYoungUnionMember
    /// </summary>
    public class rp_VietNamYoungUnionMember : XtraReport
    {
        ...
        public rp_VietNamYoungUnionMember()
        {
            InitializeComponent();
        }
        int STT = 0;
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                var result = RecordController.GetEmployeeIsVietNamYoungUnion(departments, condition);
                DataSource = result;
        ...
        {
            string resourceFileName = "rp_VietNamYoungUnionMember.resx";
            ...
            this.xrTableCell20.Text = "BÁO CÁO DANH SÁCH CÁN BỘ LÀ ĐOÀN VIÊN";
