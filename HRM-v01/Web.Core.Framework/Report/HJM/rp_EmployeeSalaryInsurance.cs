...
{
    /// <summary>
    /// Summary description for rp_EmployeeSalaryInsurance
    /// </summary>
    public class rp_EmployeeSalaryInsurance : XtraReport
    {
        ...
        public rp_EmployeeSalaryInsurance()
        {
            InitializeComponent();
        }
        int _stt;
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                var table = SQLHelper.ExecuteTable(
                    SQLManagementAdapter.GetStore_DanhSachLaoDongVaQuyLuongTrichNopBh(
                ...
                xrTableCellMucLuongDongBH.DataBindings.Add("Text", DataSource, "SalaryInsurance");
                xrTableCellNguoiLD.DataBindings.Add("Text", DataSource, "EmployeePayInsurance");
                xrTableCellDN.DataBindings.Add("Text", DataSource, "CompanyPayInsurance");
                xrTableCellCong.DataBindings.Add("Text", DataSource, "TotalInsurance");
                xrTableCellThangNamThamGiaBH.DataBindings.Add("Text", DataSource, "InsuranceIssueDate", "{0:dd/MM/yyyy}");
                xrTableCellTotalMucLuongDongBH.DataBindings.Add("Text", DataSource, "TotalSalaryInsurance");
                xrTableCellTotalNguoiLD.DataBindings.Add("Text", DataSource, "TotalEmployeePayInsurance");
                xrTableCellTotalDN.DataBindings.Add("Text", DataSource, "TotalCompanyPayInsurance");
                xrTableCellTotalCong.DataBindings.Add("Text", DataSource, "SumTotalInsurance");
        ...
        {
            string resourceFileName = "rp_EmployeeSalaryInsurance.resx";
