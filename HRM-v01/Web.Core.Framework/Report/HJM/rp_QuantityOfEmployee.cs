...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rp_QuantityOfEmployee : XtraReport
    {
        ...
        {
            string resourceFileName = "rp_QuantityOfEmployee.resx";
            ...
            this.xrCellReportName.Text = "THỐNG KÊ, TỔNG HỢP SỐ LƯỢNG, CHẤT LƯỢNG SỐ LƯỢNG NGƯỜI LÀM VIỆC TRONG CÁC ĐƠN VỊ " +
    "SỰ NGHIỆP";
