...
{
    /// <summary>
    /// Summary description for rp_RaiseSalary
    /// </summary>
    public class rp_RaiseSalary : XtraReport
    {
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                var table = SQLHelper.ExecuteTable(
                    SQLManagementSalaryAdapter.GetStore_ListEmployeeLiftSalary(string.Join(",", arrOrgCode),
                        filter.WhereClause));
                DataSource = table;
                ...
                xrTableCellThoiHanNangLuong.DataBindings.Add("Text", DataSource, "RaisingSalaryTime", "{0:dd/MM/yyyy}");
        ...
        {
            string resourceFileName = "rp_RaiseSalary.resx";
            ...
            this.xrLabel7.Text = "BÁO CÁO DANH SÁCH CÁN BỘ ĐẾN KỲ NÂNG LƯƠNG";
