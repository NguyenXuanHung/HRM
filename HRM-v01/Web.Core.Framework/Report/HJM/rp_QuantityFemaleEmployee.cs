...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rp_QuantityFemaleEmployee : XtraReport
    {
        ...
        public rp_QuantityFemaleEmployee()
        {
            InitializeComponent();
        }
        int STT=0;
        ...
        public void BindData(ReportFilter filter)
        {
            try
            {
                ...
                if (organization != null)
                {
                    ...
                    var tableGroup = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_SLCLNguoiLamViecVaBienCheCountGroupTotal(string.Join(",", arrDepartment), "LaNu", employeeType));
                    var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_SLCLNguoiLamViecVaBienCheCountTotal(string.Join(",", arrDepartment), "LaNu", employeeType));
        ...
        {
            string resourceFileName = "rp_QuantityFemaleEmployee.resx";
            ...
            this.xrCellReportName.Text = "THỐNG KÊ, TỔNG HỢP SỐ LƯỢNG, CHẤT LƯỢNG SỐ LƯỢNG NGƯỜI LÀM VIỆC LÀ NỮ";
