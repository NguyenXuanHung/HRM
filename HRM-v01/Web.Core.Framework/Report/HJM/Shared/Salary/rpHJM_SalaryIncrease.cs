...
{
    /// <summary>
    /// Summary description for rpHJM_SalaryIncrease
    /// </summary>
    public class rpHJM_SalaryIncrease : XtraReport, IBaseReport
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                var table = SQLHelper.ExecuteTable(SQLManagementAdapter.GetStore_ListSalaryRaise(string.Join(",", _filter.Departments.Split(
                    new[] { "," }, StringSplitOptions.RemoveEmptyEntries).Select(d => "'{0}'".FormatWith(d))), fromDate, toDate,null, null, (int)SalaryDecisionType.Regular, _filter.Condition, null));                
                DataSource = table;
        ...
        private void InitializeComponent()
        {
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(882.2566F, 114.8201F);
            ...
            this.lblReviewedByName.LocationFloat = new DevExpress.Utils.PointFloat(421.8399F, 122.1118F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(24.38418F, 114.8201F);
