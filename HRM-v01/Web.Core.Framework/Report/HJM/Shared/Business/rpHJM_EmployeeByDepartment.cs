...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHJM_EmployeeByDepartment : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "BÁO CÁO DANH SÁCH CÁN BỘ THEO PHÒNG BAN";
        ...
        private void InitFilter()
        {
            ...
            _filter.Items.Add(FilterGenerate.ContractStatusFilter());
        ...
        /// Default constructor
        /// </summary>
        public rpHJM_EmployeeByDepartment()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            try
            {
                // get organization              
                    ...
                    // select form db 
                    var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_EmployeeByDepartment(string.Join(",", _filter.Departments.Split(
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "BÁO CÁO DANH SÁCH CÁN BỘ THEO PHÒNG BAN";
            ...
            this.lblDuration.Font = new System.Drawing.Font("Times New Roman", 5F, System.Drawing.FontStyle.Regular, System.Drawing.GraphicsUnit.Point, ((byte)(1)), true);
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(879.7071F, 124.1951F);
            ...
            this.lblReviewedByName.LocationFloat = new DevExpress.Utils.PointFloat(423.6537F, 127.3201F);
            ...
            // xrt_stt
            // 
            this.xrt_stt.Font = new System.Drawing.Font("Times New Roman", 8.5F, System.Drawing.FontStyle.Bold);
            ...
            this.xrt_stt.Weight = 0.17653884938881112D;
            // 
