...
{
    /// <summary>
    /// Summary description for rpHJM_EmployeeSeniority
    /// </summary>
    public class rpHJM_EmployeeSeniority : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "BÁO CÁO THÂM NIÊN CÔNG TÁC CỦA CÁN BỘ";
        ...
        private void InitFilter()
        {
            ...
            // filter category VYUPosition (đoàn)            
            _filter.Items.Add(FilterGenerate.VYUPositionFilter());

            // filter salary contact type            
            _filter.Items.Add(FilterGenerate.ContractTypeFilter());
        ...
        /// Default constructor
        /// </summary>
        public rpHJM_EmployeeSeniority()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_EmployeeSeniority(string.Join(",", _filter.Departments.Split(
                    new[] { "," }, StringSplitOptions.RemoveEmptyEntries).Select(d => "'{0}'".FormatWith(d))), fromDate, toDate, _filter.Condition, TYPE_REPORT));
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "BÁO CÁO THÂM NIÊN CÔNG TÁC CỦA CÁN BỘ";
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(869.4916F, 102.3201F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(19.32208F, 102.3201F);
