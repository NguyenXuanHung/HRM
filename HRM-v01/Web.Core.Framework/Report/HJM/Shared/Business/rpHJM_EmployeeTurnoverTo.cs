...
{
    /// <summary>
    /// Summary description for rpHJM_EmployeeTurnoverTo
    /// </summary>
    public class rpHJM_EmployeeTurnoverTo : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "BÁO CÁO DANH SÁCH CÁN BỘ ĐƯỢC LUÂN CHUYỂN ĐẾN";
        ...
        /// Default constructor
        /// </summary>
        public rpHJM_EmployeeTurnoverTo()
        {
            // init compoent
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "BÁO CÁO DANH SÁCH CÁN BỘ ĐƯỢC LUÂN CHUYỂN ĐẾN";
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(864.2787F, 98.15343F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(24.38418F, 98.15343F);
            ...
            this.xrTableCellGroupCanBo.BeforePrint += new System.Drawing.Printing.PrintEventHandler(this.Group_BeforePrint);
            // 
            // xrTableCell28
            // 
