...
{
    /// <summary>
    /// Summary description for rpHJM_EmployeeExpired
    /// </summary>
    public class rpHJM_EmployeeExpired : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "BÁO CÁO DANH SÁCH HẾT HẠN HỢP ĐỒNG";
        ...
        public void BindData()
        {
            try
            {
                ...
                var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_EmployeeExpried(string.Join(",", _filter.Departments.Split(
                    new[] { "," }, StringSplitOptions.RemoveEmptyEntries).Select(d => "'{0}'".FormatWith(d))), fromDate, toDate, _filter.Condition, 30));
                DataSource = table;
                //binding data detail
                xrTableCellSoHieuCBCC.DataBindings.Add("Text", DataSource, "EmployeeCode");
                    ...
                    xrTableCellChucVuNguoiKy.DataBindings.Add("Text", DataSource, "PersonPosition");
                    xrTableCellThoiHanConLai.DataBindings.Add("Text", DataSource, "ContractRemain");
        ...
        private void InitializeComponent()
        {
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(24.38418F, 102.3201F);
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(871.0345F, 102.3201F);
