...
{
    /// <summary>
    /// Summary description for rp_CCVC_BaoCaoDanhSachCanBoCCVCToanCoQuan
    /// </summary>
    public class rpHJM_EmployeeList : XtraReport, IBaseReport
    {
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportAdapter.GetStore_EmployeeList(string.Join(",", _filter.Departments.Split(
                    new[] { "," }, StringSplitOptions.RemoveEmptyEntries).Select(d => "'{0}'".FormatWith(d))), fromDate, toDate, _filter.Condition));
                DataSource = table;

                xrLabelTongSo.Text = string.Format(xrLabelTongSo.Text, table.Rows.Count.ToString());
                ...
                xrTableCellDiaChiThuongTru.DataBindings.Add("Text", DataSource, "Address");
                ...
                xrTableCellMaNgach.DataBindings.Add("Text", DataSource, "QuantumCode");
                xrTableCellBacLuong.DataBindings.Add("Text", DataSource, "SalaryGrade");
                xrTableCellHeSo.DataBindings.Add("Text", DataSource, "SalaryFactor");
                //xrTableCellPhuCapChucVu.DataBindings.Add("Text", DataSource, "OtherAllowance");
                //xrTableCellPhuCapKhac.DataBindings.Add("Text", DataSource, "PositionAllowance");
        ...
        private void InitializeComponent()
        {
            ...
            this.xrLabelTongSo = new DevExpress.XtraReports.UI.XRLabel();
            ...
            this.xrTableCellDiaChiThuongTru.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            ...
            this.lblReportTitle.Text = "BÁO CÁO DANH SÁCH CÁN BỘ, CÔNG CHỨC, VIÊN CHỨC TOÀN CƠ QUAN ";
            ...
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCell241.Font = new System.Drawing.Font("Times New Roman", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCell242.Font = new System.Drawing.Font("Times New Roman", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(879.7071F, 101.2784F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(24.38418F, 111.6951F);
            ...
            // xrLabelTongSo
            // 
            this.xrLabelTongSo.Font = new System.Drawing.Font("Times New Roman", 8.25F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(0)));
            this.xrLabelTongSo.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
            this.xrLabelTongSo.Name = "xrLabelTongSo";
            this.xrLabelTongSo.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.xrLabelTongSo.SizeF = new System.Drawing.SizeF(204.3842F, 23F);
            this.xrLabelTongSo.StylePriority.UseFont = false;
            this.xrLabelTongSo.Text = "Tổng số CBCCVC:{0} người";
            // 
            // xrLabel2
            // 
