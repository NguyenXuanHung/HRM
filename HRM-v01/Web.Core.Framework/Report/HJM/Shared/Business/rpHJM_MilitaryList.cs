...
{
    /// <summary>
    /// Summary description for rpHJM_MilitaryList
    /// </summary>
    public class rpHJM_MilitaryList : XtraReport, IBaseReport
    {
        ...
        private XRTableCell xrTableCellNgayNhapNgu;
        ...
        private XRTableCell xrTableCellNgayXuatNgu;
        private XRTableCell xrTableCell1;
        private XRTableCell xrTableCellQuanHamCaoNhat;
        ...
        private void InitFilter()
        {
            ...
            // filter position            
            _filter.Items.Add(FilterGenerate.PositionFilter(false));

            // filter department            
            _filter.Items.Add(FilterGenerate.DepartmentFilter(false));

            // filter job title            
            _filter.Items.Add(FilterGenerate.JobTitleFilter(false));

            // filter folk (dân tộc)            
            _filter.Items.Add(FilterGenerate.FolkFilter(false));

            // filter manage level
            _filter.Items.Add(FilterGenerate.ManagementLevelFilter(false));

            // filter language level
            _filter.Items.Add(FilterGenerate.LanguageLevelFilter(false));

            // filter politic level 
            _filter.Items.Add(FilterGenerate.PoliticLevelFilter(false));

            // filter education 
            _filter.Items.Add(FilterGenerate.EducationFilter(false));
        }

        /// <summary>
        /// Default constructor
        /// </summary>
        public rpHJM_MilitaryList()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            try
            {
                ...
                var result = RecordController.GetEmployeeIsMilitary(_filter.Departments, fromDate, toDate, _filter.Condition, null, 0, 1000);
                DataSource = result.Data.OrderBy(r => r.DepartmentId);
                ...
                xrTableCellLyLuanChinhTri.DataBindings.Add("Text", DataSource, "PoliticLevelName");
                ...
                xrTableCellNgayNhapNgu.DataBindings.Add("Text", DataSource, "ArmyJoinedDate", "{0:dd/MM/yyyy}");
                xrTableCellNgayXuatNgu.DataBindings.Add("Text", DataSource, "ArmyLeftDate", "{0:dd/MM/yyyy}");
                xrTableCellQuanHamCaoNhat.DataBindings.Add("Text", DataSource, "ArmyLevelName");
        ...
        private void InitializeComponent()
        {
            ...
            this.xrTableCellNgayNhapNgu = new DevExpress.XtraReports.UI.XRTableCell();
            this.xrTableCellNgayXuatNgu = new DevExpress.XtraReports.UI.XRTableCell();
            this.xrTableCellQuanHamCaoNhat = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTableCellNgayNhapNgu,
            this.xrTableCellNgayXuatNgu,
            this.xrTableCellQuanHamCaoNhat});
            ...
            // 
            // xrTableCellNgayNhapNgu
            // 
            this.xrTableCellNgayNhapNgu.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellNgayNhapNgu.Name = "xrTableCellNgayNhapNgu";
            this.xrTableCellNgayNhapNgu.StylePriority.UseBorders = false;
            this.xrTableCellNgayNhapNgu.StylePriority.UseTextAlignment = false;
            this.xrTableCellNgayNhapNgu.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellNgayNhapNgu.Weight = 0.13873719086771102D;
            // 
            // xrTableCellNgayXuatNgu
            // 
            this.xrTableCellNgayXuatNgu.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellNgayXuatNgu.Name = "xrTableCellNgayXuatNgu";
            this.xrTableCellNgayXuatNgu.StylePriority.UseBorders = false;
            this.xrTableCellNgayXuatNgu.StylePriority.UseTextAlignment = false;
            this.xrTableCellNgayXuatNgu.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellNgayXuatNgu.Weight = 0.16648465949202129D;
            // 
            // xrTableCellQuanHamCaoNhat
            // 
            this.xrTableCellQuanHamCaoNhat.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellQuanHamCaoNhat.Name = "xrTableCellQuanHamCaoNhat";
            this.xrTableCellQuanHamCaoNhat.StylePriority.UseBorders = false;
            this.xrTableCellQuanHamCaoNhat.StylePriority.UseTextAlignment = false;
            this.xrTableCellQuanHamCaoNhat.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleLeft;
            this.xrTableCellQuanHamCaoNhat.Weight = 0.16648465949202129D;
            // 
            // TopMargin
            // 
            ...
            this.lblReportTitle.Text = "BÁO CÁO DANH SÁCH CÁN BỘ LÀ QUÂN NHÂN";
            ...
            this.xrTableCell3.Text = "Ngày nhập ngũ";
            this.xrTableCell3.Weight = 0.19842359787139022D;
            // 
            // lblReviewedByName
            // 
            this.lblReviewedByName.BorderColor = System.Drawing.Color.DarkGray;
            this.lblReviewedByName.Borders = ((DevExpress.XtraPrinting.BorderSide)((((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Top) 
            | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.lblReviewedByName.Font = new System.Drawing.Font("Times New Roman", 5F, System.Drawing.FontStyle.Bold);
            this.lblReviewedByName.Name = "lblReviewedByName";
            this.lblReviewedByName.StylePriority.UseBorderColor = false;
            this.lblReviewedByName.StylePriority.UseBorders = false;
            this.lblReviewedByName.StylePriority.UseFont = false;
            this.lblReviewedByName.Text = "Ngày xuất ngũ";
            this.lblReviewedByName.Weight = 0.23810834439710932D;
            // 
            // xrTableCell1
            // 
            ...
            this.xrTableCell1.Text = "Quân hàm cao nhất";
            this.xrTableCell1.Weight = 0.23810834439710932D;
            // 
            // formattingRule1
            // 
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(865.3203F, 110.6534F);
            ...
            this.xrLabel4.LocationFloat = new DevExpress.Utils.PointFloat(423.6537F, 112.7368F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(24.38431F, 110.6534F);
            ...
            this.xrTableCell27.Weight = 0.22373040552608467D;
            // 
            ...
            this.xrTableCellGroupHead.Weight = 11.29626383806835D;
