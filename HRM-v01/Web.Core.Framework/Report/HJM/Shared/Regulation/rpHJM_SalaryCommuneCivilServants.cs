...
namespace Web.Core.Framework.Report
{
    ...
    /// <summary>
    /// Summary description for rpHJM_SalaryCommuneCivilServants
    /// </summary>
    public class rpHJM_SalaryCommuneCivilServants : XtraReport, IBaseReport
{
    ...
    private const string _reportTitle = "DANH SÁCH VÀ TIỀN LƯƠNG CÁN BỘ, CÔNG CHỨC CẤP XÃ";
    ...
    /// Default constructor
    /// </summary>
    public rpHJM_SalaryCommuneCivilServants()
    {
        // init compoent
        InitializeComponent();
    ...
    public void BindData()
    {
        try
        {
            ...
            var arrOrgCode = string.IsNullOrEmpty(_filter.Departments)
                ...
                var table = SQLHelper.ExecuteTable(SQLReportRegulationAdapter.GetStore_SalarycommuneCivilServants(string.Join(",", _filter.Departments.Split(
    ...
    private void InitializeComponent()
    {
            ...
            this.lblReportTitle.Text = "BÁO CÁO DANH SÁCH VÀ TIỀN LƯƠNG CÁN BỘ, CÔNG CHỨC CẤP XÃ NĂM {0}";
    ...
    "i vụ";
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(757.5368F, 123.0001F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(108.5785F, 121.9584F);
            ...
            // 
            // rpHJM_SalaryCommuneCivilServants
            // 
