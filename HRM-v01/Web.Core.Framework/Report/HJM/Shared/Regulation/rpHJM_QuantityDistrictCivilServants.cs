...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHJM_QuantityDistrictCivilServants : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "BÁO CÁO SỐ LƯỢNG, CHẤT LƯỢNG CÁN BỘ CÔNG CHỨC CẤP HUYỆN";
        ...
        /// Default constructor
        /// </summary>
        public rpHJM_QuantityDistrictCivilServants()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportRegulationAdapter.GetStore_QuantityDistrictCivilServants(string.Join(",", _filter.Departments.Split(
    ...
    "i vụ";
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(727.8501F, 126.1251F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(106F, 132.3751F);
            ...
            // 
            // rpHJM_QuantityDistrictCivilServants
            // 
