...
namespace Web.Core.Framework.Report
{
    ...
    /// <summary>
    /// BAO CAO THỐNG KÊ, TỔNG HỢP SỐ LƯỢNG, CHẤT LƯỢNG SỐ LƯỢNG NGƯỜI LÀM VIỆC TRONG CÁC ĐƠN VỊ SỰ NGHIỆP
    /// </summary>
    public class rpHJM_QuantityOfEmployee : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "SỐ LƯỢNG, CHẤT LƯỢNG SỐ LƯỢNG NGƯỜI LÀM VIỆC TRONG CÁC ĐƠN VỊ SỰ NGHIỆP";
        ...
        /// Default constructor
        /// </summary>
        public rpHJM_QuantityOfEmployee()
        {
            // init compoent
            InitializeComponent();
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "THỐNG KÊ, TỔNG HỢP SỐ LƯỢNG, CHẤT LƯỢNG SỐ LƯỢNG NGƯỜI LÀM VIỆC TRONG CÁC ĐƠN VỊ " +
    "SỰ NGHIỆP";
