...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHJM_QuantityEthnicMinority : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "SỐ LƯỢNG, CHẤT LƯỢNG NGƯỜI LÀM VIỆC LÀ NGƯỜI DÂN TỘC THIỂU SỐ";
        ...
        /// Default constructor
        /// </summary>
        public rpHJM_QuantityEthnicMinority()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db
                var tableGroup = SQLHelper.ExecuteTable(SQLReportRegulationAdapter.GetStore_QuantityEthnicMinorityCountGroupTotal(string.Join(",", _filter.Departments.Split(
                    new[] { "," }, StringSplitOptions.RemoveEmptyEntries).Select(d => "'{0}'".FormatWith(d))), _filter.EmployeeType));
                var table = SQLHelper.ExecuteTable(SQLReportRegulationAdapter.GetStore_QuantityEthnicMinorityCountTotal(string.Join(",", _filter.Departments.Split(
                    new[] { "," }, StringSplitOptions.RemoveEmptyEntries).Select(d => "'{0}'".FormatWith(d))), _filter.EmployeeType));
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "THỐNG KÊ, TỔNG HỢP SỐ LƯỢNG, CHẤT LƯỢNG SỐ LƯỢNG NGƯỜI LÀM VIỆC LÀ NGƯỜI DÂN TỘC " +
    "THIỂU SỐ";
