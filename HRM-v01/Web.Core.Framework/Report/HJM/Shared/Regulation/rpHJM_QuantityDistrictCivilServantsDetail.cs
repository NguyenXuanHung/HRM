...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHJM_QuantityDistrictCivilServantsDetail : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "SỐ LƯỢNG, CHẤT LƯỢNG CÁN BỘ, CÔNG CHỨC CẤP HUYỆN CHI TIẾT";
        ...
        /// Default constructor
        /// </summary>
        public rpHJM_QuantityDistrictCivilServantsDetail()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            try
            {
                ...
                // select form db 
                var table = SQLHelper.ExecuteTable(SQLReportRegulationAdapter.GetStore_QuantyDistrictDetail(string.Join(",", _filter.Departments.Split(
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "BÁO CÁO SỐ LƯỢNG, CHẤT LƯỢNG CÔNG CHỨC TỪ CẤP HUYỆN TRỞ LÊN NĂM {0}";
    ...
    "i vụ";
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(750.5216F, 123.0001F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(108.5785F, 123.0001F);
            ...
            // 
            // rpHJM_QuantityDistrictCivilServantsDetail
            // 
