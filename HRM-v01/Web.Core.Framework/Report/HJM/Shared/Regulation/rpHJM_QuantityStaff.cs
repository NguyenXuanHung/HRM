...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rpHJM_QuantityStaff : XtraReport, IBaseReport
    {
        ...
        private const string _reportTitle = "SỐ LƯỢNG, CHẤT LƯỢNG BIÊN CHẾ SỰ NGHIỆP";
        /// <summary>
        /// Filter data
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.lblReportTitle.Text = "THỐNG KÊ, TỔNG HỢP SỐ LƯỢNG, CHẤT LƯỢNG BIÊN CHẾ SỰ NGHIỆP";
