...
{
    /// <summary>
    /// Summary description for rpHJM_QuantityCommuneCivilServants
    /// </summary>
    public class rpHJM_QuantityCommuneCivilServants : XtraReport, IBaseReport
    {
        ...
        private XRLabel lblHocVanPhoThong;
        ...
        private XRTableCell xrTableCellTongSo;
        ...
        private XRTableCell xrTableCellCanBoCapXa;
        private XRTableCell xrTableCellCongChucChuyenMon;
        ...
        private XRTableCell xrTableCellTieuHoc;
        ...
        private XRTableCell xrTableCellChuaQuaDaoTao;
        ...
        private XRTableCell xrTableCellLuanChuyenTuHuyen;
        private XRTable tblFooter;
        private XRTableRow xrTableRow1;
        private XRTableCell xrTextTongSo;
        private XRTableCell xrTongSo;
        ...
        private XRTableCell xrTongCanBoCapXa;
        private XRTableCell xrTongCongChucChuyenMon;
        ...
        private XRTableCell xrTongTieuHoc;
        ...
        private XRTableCell xrTongChuaQuaDaoTao;
        ...
        private XRTableCell xrTongNam55Den60;
        private XRTableCell xrTongTrenTuoiNghiHuu;
        private XRTableCell xrTongLuanChuyenTuHuyen;
        ...
        private const string _reportTitle = "SỐ LƯỢNG, CHẤT LƯỢNG CÁN BỘ, CÔNG CHỨC CẤP XÃ";
        ...
        /// Default constructor
        /// </summary>
        public rpHJM_QuantityCommuneCivilServants()
        {
            // init compoent
            InitializeComponent();
        ...
        public void BindData()
        {
            ...
            // select form db
            var arrOrgCode = string.IsNullOrEmpty(_filter.Departments)
                ? new string[] { }
                : _filter.Departments.Split(new[] { "," }, StringSplitOptions.RemoveEmptyEntries);
            var table = SQLHelper.ExecuteTable(SQLReportRegulationAdapter.GetStore_QuantityCommuneCivilServants(string.Join(",", _filter.Departments.Split(
                new[] { "," }, StringSplitOptions.RemoveEmptyEntries).Select(d => "'{0}'".FormatWith(d))), fromDate, toDate, _filter.Condition), new[] { "@MaDonVi" },
            ...
            {
                row["Hoten"] = (string)table.Rows[j]["TenDonVi"];
                break;
            }
            ...
            xrTableCellTenDonVi.DataBindings.Add("Text", DataSource, "HoTen");
            xrTableCellNu.DataBindings.Add("Text", DataSource, "Nu");
            xrTableCellDangVien.DataBindings.Add("Text", DataSource, "DangVien");
            xrTableCellDanTocThieuSo.DataBindings.Add("Text", DataSource, "DanTocThieuSo");
            xrTableCellTonGiao.DataBindings.Add("Text", DataSource, "TonGiao");
            xrTableCellCanBoCapXa.DataBindings.Add("Text", DataSource, "CanBoCapXa");
            xrTableCellCongChucChuyenMon.DataBindings.Add("Text", DataSource, "CongChucChuyenMon");
            xrTableCellTienSi.DataBindings.Add("Text", DataSource, "TienSi");
            xrTableCellThacSi.DataBindings.Add("Text", DataSource, "ThacSi");
            xrTableCellDaiHoc.DataBindings.Add("Text", DataSource, "DaiHoc");
            xrTableCellCaoDang.DataBindings.Add("Text", DataSource, "CaoDang");
            xrTableCellTrungCap.DataBindings.Add("Text", DataSource, "TrungCap");
            xrTableCellSoCap.DataBindings.Add("Text", DataSource, "SoCap");
            xrTableCellTHPT.DataBindings.Add("Text", DataSource, "THPT");
            xrTableCellTHCS.DataBindings.Add("Text", DataSource, "THCS");
            xrTableCellTieuHoc.DataBindings.Add("Text", DataSource, "TieuHoc");
            xrTableCellCuNhanChinhTri.DataBindings.Add("Text", DataSource, "CuNhanChinhTri");
            xrTableCellCaoCapChinhTri.DataBindings.Add("Text", DataSource, "CaoCapChinhTri");
            xrTableCellTrungCapChinhTri.DataBindings.Add("Text", DataSource, "TrungCapChinhTri");
            xrTableCellSoCapChinhTri.DataBindings.Add("Text", DataSource, "SoCapChinhTri");
            xrTableCellTrungCapTinHoc.DataBindings.Add("Text", DataSource, "TrungCapTinHoc");
            xrTableCellChungChiTinHoc.DataBindings.Add("Text", DataSource, "ChungChiTinHoc");
            xrTableCellDaiHocTiengAnh.DataBindings.Add("Text", DataSource, "DaiHocTiengAnh");
            xrTableCellChungChiTiengAnh.DataBindings.Add("Text", DataSource, "ChungChiTiengAnh");
            xrTableCellDaiHocNgoaiNguKhac.DataBindings.Add("Text", DataSource, "DaiHocNgoaiNguKhac");
            xrTableCellChungChiNgoaiNguKhac.DataBindings.Add("Text", DataSource, "ChungChiNgoaiNguKhac");
            xrTableCellChungChiTiengDanToc.DataBindings.Add("Text", DataSource, "ChungChiTiengDanToc");
            xrTableCellChuyenVienChinh.DataBindings.Add("Text", DataSource, "ChuyenVienChinh");
            xrTableCellChuyenVien.DataBindings.Add("Text", DataSource, "ChuyenVien");
            xrTableCellChuaQuaDaoTao.DataBindings.Add("Text", DataSource, "ChuaQuaDaoTao");
            xrTableCellDuoi30.DataBindings.Add("Text", DataSource, "Duoi30");
            xrTableCell31Den40.DataBindings.Add("Text", DataSource, "Tu31Den40");
            xrTableCell41Den50.DataBindings.Add("Text", DataSource, "Tu41Den50");
            xrTableCell51Den60.DataBindings.Add("Text", DataSource, "Tu51Den60");
            xrTableCellNu51Den55.DataBindings.Add("Text", DataSource, "Nu51Den55");
            xrTableCellNam56Den60.DataBindings.Add("Text", DataSource, "Nam56Den60");
            xrTableCellTrenTuoiNghiHuu.DataBindings.Add("Text", DataSource, "TrenTuoiNghiHuu");
            xrTableCellLuanChuyenTuHuyen.DataBindings.Add("Text", DataSource, "LuanChuyenTuHuyen");

            // bind report footer
            xrTongSo.DataBindings.Add("Text", DataSource, "xTongSo", "{0:n0}");
            ...
            xrTongCanBoCapXa.DataBindings.Add("Text", DataSource, "xCanBoCapXa", "{0:n0}");
            xrTongCongChucChuyenMon.DataBindings.Add("Text", DataSource, "xCongChucChuyenMon", "{0:n0}");
            ...
            xrTongTHPT.DataBindings.Add("Text", DataSource, "xTHPT", "{0:n0}");
            xrTongTHCS.DataBindings.Add("Text", DataSource, "xTHCS", "{0:n0}");
            xrTongTieuHoc.DataBindings.Add("Text", DataSource, "xTieuHoc", "{0:n0}");
            ...
            xrTongChuaQuaDaoTao.DataBindings.Add("Text", DataSource, "xChuaQuaDaoTao", "{0:n0}");
            ...
            xrTongNam55Den60.DataBindings.Add("Text", DataSource, "xNam56Den60", "{0:n0}");
            xrTongTrenTuoiNghiHuu.DataBindings.Add("Text", DataSource, "xTrenTuoiNghiHuu", "{0:n0}");
            xrTongLuanChuyenTuHuyen.DataBindings.Add("Text", DataSource, "xLuanChuyenTuHuyen", "{0:n0}");
            // other items
            // label org name
        ...
        private void InitializeComponent()
        {
            ...
            this.xrTableCellTongSo = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTableCellCanBoCapXa = new DevExpress.XtraReports.UI.XRTableCell();
            this.xrTableCellCongChucChuyenMon = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTableCellTieuHoc = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTableCellChuaQuaDaoTao = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTableCellLuanChuyenTuHuyen = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.lblHocVanPhoThong = new DevExpress.XtraReports.UI.XRLabel();
            ...
            this.xrTongSo = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTongCanBoCapXa = new DevExpress.XtraReports.UI.XRTableCell();
            this.xrTongCongChucChuyenMon = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTongTieuHoc = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTongChuaQuaDaoTao = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTongNam55Den60 = new DevExpress.XtraReports.UI.XRTableCell();
            this.xrTongTrenTuoiNghiHuu = new DevExpress.XtraReports.UI.XRTableCell();
            this.xrTongLuanChuyenTuHuyen = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrTableCellTongSo,
            this.xrTableCellNu,
            this.xrTableCellDangVien,
            this.xrTableCellDanTocThieuSo,
            this.xrTableCellTonGiao,
            this.xrTableCellCanBoCapXa,
            this.xrTableCellCongChucChuyenMon,
            ...
            this.xrTableCellLuanChuyenTuHuyen});
            ...
            // xrTableCellTongSo
            // 
            this.xrTableCellTongSo.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellTongSo.Name = "xrTableCellTongSo";
            this.xrTableCellTongSo.StylePriority.UseBorders = false;
            this.xrTableCellTongSo.StylePriority.UseTextAlignment = false;
            this.xrTableCellTongSo.Text = " ";
            this.xrTableCellTongSo.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellTongSo.Weight = 0.22999999999999998D;
            // 
            // xrTableCellNu
            // 
            ...
            // 
            // xrTableCellCanBoCapXa
            // 
            this.xrTableCellCanBoCapXa.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellCanBoCapXa.Name = "xrTableCellCanBoCapXa";
            this.xrTableCellCanBoCapXa.StylePriority.UseBorders = false;
            this.xrTableCellCanBoCapXa.StylePriority.UseTextAlignment = false;
            this.xrTableCellCanBoCapXa.Text = " ";
            this.xrTableCellCanBoCapXa.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellCanBoCapXa.Weight = 0.22999999999999998D;
            // 
            // xrTableCellCongChucChuyenMon
            // 
            this.xrTableCellCongChucChuyenMon.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellCongChucChuyenMon.Name = "xrTableCellCongChucChuyenMon";
            this.xrTableCellCongChucChuyenMon.StylePriority.UseBorders = false;
            this.xrTableCellCongChucChuyenMon.StylePriority.UseTextAlignment = false;
            this.xrTableCellCongChucChuyenMon.Text = " ";
            this.xrTableCellCongChucChuyenMon.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellCongChucChuyenMon.Weight = 0.22999999999999998D;
            // 
            // xrTableCellTienSi
            // 
            ...
            this.xrTableCellTHPT.Weight = 0.22999999999999998D;
            // 
            // xrTableCellTHCS
            // 
            ...
            this.xrTableCellTHCS.Weight = 0.22999999999999998D;
            // 
            // xrTableCellTieuHoc
            // 
            this.xrTableCellTieuHoc.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellTieuHoc.Name = "xrTableCellTieuHoc";
            this.xrTableCellTieuHoc.StylePriority.UseBorders = false;
            this.xrTableCellTieuHoc.StylePriority.UseTextAlignment = false;
            this.xrTableCellTieuHoc.Text = " ";
            this.xrTableCellTieuHoc.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellTieuHoc.Weight = 0.22999999999999998D;
            // 
            ...
            this.xrTableCellChuyenVien.Weight = 0.22999999999999998D;
            // 
            // xrTableCellChuaQuaDaoTao
            // 
            this.xrTableCellChuaQuaDaoTao.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellChuaQuaDaoTao.Name = "xrTableCellChuaQuaDaoTao";
            this.xrTableCellChuaQuaDaoTao.StylePriority.UseBorders = false;
            this.xrTableCellChuaQuaDaoTao.StylePriority.UseTextAlignment = false;
            this.xrTableCellChuaQuaDaoTao.Text = " ";
            this.xrTableCellChuaQuaDaoTao.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellChuaQuaDaoTao.Weight = 0.24D;
            // 
            // xrTableCellDuoi30
            // 
            ...
            // 
            this.xrTableCellTrenTuoiNghiHuu.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            ...
            // 
            // xrTableCellLuanChuyenTuHuyen
            // 
            this.xrTableCellLuanChuyenTuHuyen.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellLuanChuyenTuHuyen.Name = "xrTableCellLuanChuyenTuHuyen";
            this.xrTableCellLuanChuyenTuHuyen.StylePriority.UseBorders = false;
            this.xrTableCellLuanChuyenTuHuyen.StylePriority.UseTextAlignment = false;
            this.xrTableCellLuanChuyenTuHuyen.Text = " ";
            this.xrTableCellLuanChuyenTuHuyen.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.xrTableCellLuanChuyenTuHuyen.Weight = 0.22999999999999998D;
            // 
            // TopMargin
            // 
            ...
            this.xrCellTenBieuMau.Text = "BM02/BNV";
            ...
            this.lblReportTitle.Text = "BÁO CÁO SỐ LƯỢNG, CHẤT LƯỢNG CÁN BỘ, CÔNG CHỨC CẤP XÃ NĂM {0}";
    ...
    "i vụ";
            ...
            this.xrTableCell1.Text = "Tổng số";
            ...
            this.xrTableCell3.Weight = 0.45999999999999991D;
            // 
            // lblChucDanh
            // 
            this.lblChucDanh.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Top)));
            this.lblChucDanh.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
            this.lblChucDanh.Name = "lblChucDanh";
            this.lblChucDanh.Padding = new DevExpress.XtraPrinting.PaddingInfo(0, 0, 0, 0, 100F);
            this.lblChucDanh.SizeF = new System.Drawing.SizeF(46F, 25F);
            this.lblChucDanh.StylePriority.UseBorders = false;
            ...
            this.xrTableRow6});
            this.xrTable4.SizeF = new System.Drawing.SizeF(46F, 205F);
            // 
            // xrTableRow6
            // 
            ...
            this.xrTableCell11.Text = "Cán bộ cấp xã";
            ...
            this.xrTableCell12.Text = "Công chức chuyên môn";
            ...
            this.xrTableCell4.Weight = 5.2999999999999989D;
            // 
            // lblTrinhDo
            // 
            ...
            this.lblTrinhDo.SizeF = new System.Drawing.SizeF(530F, 25F);
            ...
            this.xrTableRow7});
            this.xrTable5.SizeF = new System.Drawing.SizeF(530F, 205F);
            // 
            // xrTableRow7
            // 
            ...
            // lblHocVanPhoThong
            // 
            this.lblHocVanPhoThong.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Top)));
            this.lblHocVanPhoThong.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
            this.lblHocVanPhoThong.Name = "lblHocVanPhoThong";
            this.lblHocVanPhoThong.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.lblHocVanPhoThong.SizeF = new System.Drawing.SizeF(69F, 25F);
            this.lblHocVanPhoThong.StylePriority.UseBorders = false;
            this.lblHocVanPhoThong.Text = "Học vấn phổ thông";
            // 
            // xrTable7
            // 
            ...
            this.xrTableCell26.Text = "Trung học phổ thông";
            this.xrTableCell26.Weight = 0.22999999999999998D;
            // 
            // xrTableCell27
            // 
            ...
            this.xrTableCell27.Text = "Trung học cơ sở";
            this.xrTableCell27.Weight = 0.22999999999999998D;
            // 
            // xrTableCell28
            // 
            ...
            this.xrTableCell28.Text = "Tiểu học";
            this.xrTableCell28.Weight = 0.22999999999999998D;
            // 
            // xrTableCell15
            // 
            ...
            this.xrTableCell19.Weight = 0.70000000000000018D;
            // 
            // lblQuanLyNhaNuoc
            // 
            ...
            this.lblQuanLyNhaNuoc.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
            ...
            this.lblQuanLyNhaNuoc.SizeF = new System.Drawing.SizeF(70F, 25F);
            ...
            this.xrTable11.LocationFloat = new DevExpress.Utils.PointFloat(0F, 25F);
            this.xrTable11.Name = "xrTable11";
            this.xrTable11.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow16});
            this.xrTable11.SizeF = new System.Drawing.SizeF(70F, 180F);
            ...
            this.xrTableCell39.Text = "Chuyên viên chính & TĐ";
            ...
            this.xrTableCell40.Text = "Chuyên viên & TĐ";
            ...
            this.xrTableCell41.Text = "Chưa qua đào tạo";
            ...
            this.xrTableCell6.Text = "Công chức luân chuyển từ cấp huyện";
            ...
            this.lblSignedByName.LocationFloat = new DevExpress.Utils.PointFloat(750F, 121.9584F);
            ...
            this.lblCreatedByName.LocationFloat = new DevExpress.Utils.PointFloat(106F, 126.1251F);
            ...
            // tblFooter
            // 
            this.tblFooter.Borders = DevExpress.XtraPrinting.BorderSide.None;
            this.tblFooter.LocationFloat = new DevExpress.Utils.PointFloat(0F, 0F);
            this.tblFooter.Name = "tblFooter";
            this.tblFooter.Rows.AddRange(new DevExpress.XtraReports.UI.XRTableRow[] {
            this.xrTableRow1});
            this.tblFooter.SizeF = new System.Drawing.SizeF(1138F, 25F);
            this.tblFooter.StylePriority.UseBorders = false;
            // 
            // xrTableRow1
            // 
            ...
            this.xrTongTonGiao,
            this.xrTongCanBoCapXa,
            this.xrTongCongChucChuyenMon,
            this.xrTongTienSi,
            this.xrTongThacSi,
            this.xrTongDaiHoc,
            this.xrTongCaoDang,
            ...
            this.xrTongChuaQuaDaoTao,
            this.xrTongDuoi30,
            this.xrTong31Den40,
            this.xrTong41Den50,
            this.xrTong51Den60,
            this.xrTongNu51Den55,
            this.xrTongNam55Den60,
            this.xrTongTrenTuoiNghiHuu,
            this.xrTongLuanChuyenTuHuyen});
            ...
            // xrTongSo
            // 
            this.xrTongSo.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTongSo.Name = "xrTongSo";
            this.xrTongSo.StylePriority.UseBorders = false;
            this.xrTongSo.Weight = 0.22999999999999998D;
            // 
            // xrTongNu
            // 
            ...
            // xrTongCanBoCapXa
            // 
            this.xrTongCanBoCapXa.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTongCanBoCapXa.Name = "xrTongCanBoCapXa";
            this.xrTongCanBoCapXa.StylePriority.UseBorders = false;
            this.xrTongCanBoCapXa.Weight = 0.22999999999999998D;
            // 
            // xrTongCongChucChuyenMon
            // 
            this.xrTongCongChucChuyenMon.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTongCongChucChuyenMon.Name = "xrTongCongChucChuyenMon";
            this.xrTongCongChucChuyenMon.StylePriority.UseBorders = false;
            this.xrTongCongChucChuyenMon.Weight = 0.22999999999999998D;
            // 
            // xrTongTienSi
            // 
            ...
            this.xrTongTHPT.Weight = 0.22999999999999998D;
            // 
            // xrTongTHCS
            // 
            ...
            this.xrTongTHCS.Weight = 0.22999999999999998D;
            // 
            // xrTongTieuHoc
            // 
            this.xrTongTieuHoc.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTongTieuHoc.Name = "xrTongTieuHoc";
            this.xrTongTieuHoc.StylePriority.UseBorders = false;
            this.xrTongTieuHoc.Weight = 0.22999999999999998D;
            // 
            ...
            this.xrTongChuyenVien.Weight = 0.22999999999999998D;
            // 
            // xrTongChuaQuaDaoTao
            // 
            this.xrTongChuaQuaDaoTao.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTongChuaQuaDaoTao.Name = "xrTongChuaQuaDaoTao";
            this.xrTongChuaQuaDaoTao.StylePriority.UseBorders = false;
            this.xrTongChuaQuaDaoTao.Weight = 0.24D;
            // 
            // xrTongDuoi30
            // 
            ...
            // xrTongNam55Den60
            // 
            this.xrTongNam55Den60.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTongNam55Den60.Name = "xrTongNam55Den60";
            this.xrTongNam55Den60.StylePriority.UseBorders = false;
            this.xrTongNam55Den60.Weight = 0.22999999999999998D;
            // 
            // xrTongTrenTuoiNghiHuu
            // 
            this.xrTongTrenTuoiNghiHuu.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            ...
            // 
            // xrTongLuanChuyenTuHuyen
            // 
            this.xrTongLuanChuyenTuHuyen.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTongLuanChuyenTuHuyen.Name = "xrTongLuanChuyenTuHuyen";
            this.xrTongLuanChuyenTuHuyen.StylePriority.UseBorders = false;
            this.xrTongLuanChuyenTuHuyen.Weight = 0.22999999999999998D;
            // 
            // lblKyHoTen
            // 
            ...
            // 
            // rpHJM_QuantityCommuneCivilServants
            // 
