...
namespace Web.Core.Framework.Report
{
    ...
    /// </summary>
    public class rp_TimeKeepingOffice : XtraReport, IBaseReport
    {
        ...
        {
            string resourceFileName = "rp_TimeKeepingOffice.resx";
