...
{
    /// <summary>
    /// Báo cáo chi tiết chấm công hành chính
    /// </summary>
    public class rp_TimeKeepingOfficeDetail : XtraReport, IBaseReport
    {
        ...
        public rp_TimeKeepingOfficeDetail()
        {
            InitializeComponent();
            // init Filter
            InitFilter();
        ...
        public void BindData()
        {
            ...
            xrtDay1.DataBindings.Add("Text", DataSource, "Day1.DetailDisplay");
            xrtDay2.DataBindings.Add("Text", DataSource, "Day2.DetailDisplay");
            xrtDay3.DataBindings.Add("Text", DataSource, "Day3.DetailDisplay");
            xrtDay4.DataBindings.Add("Text", DataSource, "Day4.DetailDisplay");
            xrtDay5.DataBindings.Add("Text", DataSource, "Day5.DetailDisplay");
            xrtDay6.DataBindings.Add("Text", DataSource, "Day6.DetailDisplay");
            xrtDay7.DataBindings.Add("Text", DataSource, "Day7.DetailDisplay");
            xrtDay8.DataBindings.Add("Text", DataSource, "Day8.DetailDisplay");
            xrtDay9.DataBindings.Add("Text", DataSource, "Day9.DetailDisplay");
            xrtDay10.DataBindings.Add("Text", DataSource, "Day10.DetailDisplay");
            xrtDay11.DataBindings.Add("Text", DataSource, "Day11.DetailDisplay");
            xrtDay12.DataBindings.Add("Text", DataSource, "Day12.DetailDisplay");
            xrtDay13.DataBindings.Add("Text", DataSource, "Day13.DetailDisplay");
            xrtDay14.DataBindings.Add("Text", DataSource, "Day14.DetailDisplay");
            xrtDay15.DataBindings.Add("Text", DataSource, "Day15.DetailDisplay");
            xrtDay16.DataBindings.Add("Text", DataSource, "Day16.DetailDisplay");
            xrtDay17.DataBindings.Add("Text", DataSource, "Day17.DetailDisplay");
            xrtDay18.DataBindings.Add("Text", DataSource, "Day18.DetailDisplay");
            xrtDay19.DataBindings.Add("Text", DataSource, "Day19.DetailDisplay");
            xrtDay20.DataBindings.Add("Text", DataSource, "Day20.DetailDisplay");
            xrtDay21.DataBindings.Add("Text", DataSource, "Day21.DetailDisplay");
            xrtDay22.DataBindings.Add("Text", DataSource, "Day22.DetailDisplay");
            xrtDay23.DataBindings.Add("Text", DataSource, "Day23.DetailDisplay");
            xrtDay24.DataBindings.Add("Text", DataSource, "Day24.DetailDisplay");
            xrtDay25.DataBindings.Add("Text", DataSource, "Day25.DetailDisplay");
            xrtDay26.DataBindings.Add("Text", DataSource, "Day26.DetailDisplay");
            xrtDay27.DataBindings.Add("Text", DataSource, "Day27.DetailDisplay");
            xrtDay28.DataBindings.Add("Text", DataSource, "Day28.DetailDisplay");
            xrtDay29.DataBindings.Add("Text", DataSource, "Day29.DetailDisplay");
            xrtDay30.DataBindings.Add("Text", DataSource, "Day30.DetailDisplay");
            xrtDay31.DataBindings.Add("Text", DataSource, "Day31.DetailDisplay");
        ...
        {
            string resourceFileName = "rp_TimeKeepingOfficeDetail.resx";
