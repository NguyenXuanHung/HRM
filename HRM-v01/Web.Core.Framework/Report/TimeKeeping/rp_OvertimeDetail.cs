...
{
    /// <summary>
    /// Báo cáo chi tiết tăng ca
    /// </summary>
    public class rp_OvertimeDetail : XtraReport, IBaseReport
    {
        ...
        private XRTableCell EmployeeCode;
        ...
        private XRTableCell totalOverTimeDay;
        ...
        private XRTableCell totalOverTimeNight;
        private XRTableCell totalOverTimeHoliday;
        private XRTableCell totalOverTimeWeekend;
        private XRTableCell TotalAllOverTime;
        ...
        {
            var timeSheetReportId = _filter.TimeSheetReportId;
            var timeSheetReport = hr_TimeSheetReportServices.GetById(timeSheetReportId);
            if (timeSheetReport != null)
            {
                xrCellReportName.Text = timeSheetReport.Title;
                SetColorByDay(timeSheetReportId, timeSheetReport.Month, timeSheetReport.Year);
            }
            
            var data = TimeSheetController.GetAllTimeSheet(ConstTypeTimeSheet, timeSheetReportId);
            DataSource = data;
            xrTableCellFullName.DataBindings.Add("Text", DataSource, "FullName");
            EmployeeCode.DataBindings.Add("Text", DataSource, "EmployeeCode");
            xrtDay1.DataBindings.Add("Text", DataSource, "Day1.TimeConvert");
            xrtDay2.DataBindings.Add("Text", DataSource, "Day2.TimeConvert");
            xrtDay3.DataBindings.Add("Text", DataSource, "Day3.TimeConvert");
            xrtDay4.DataBindings.Add("Text", DataSource, "Day4.TimeConvert");
            xrtDay5.DataBindings.Add("Text", DataSource, "Day5.TimeConvert");
            xrtDay6.DataBindings.Add("Text", DataSource, "Day6.TimeConvert");
            xrtDay7.DataBindings.Add("Text", DataSource, "Day7.TimeConvert");
            xrtDay8.DataBindings.Add("Text", DataSource, "Day8.TimeConvert");
            xrtDay9.DataBindings.Add("Text", DataSource, "Day9.TimeConvert");
            xrtDay10.DataBindings.Add("Text", DataSource, "Day10.TimeConvert");
            xrtDay11.DataBindings.Add("Text", DataSource, "Day11.TimeConvert");
            xrtDay12.DataBindings.Add("Text", DataSource, "Day12.TimeConvert");
            xrtDay13.DataBindings.Add("Text", DataSource, "Day13.TimeConvert");
            xrtDay14.DataBindings.Add("Text", DataSource, "Day14.TimeConvert");
            xrtDay15.DataBindings.Add("Text", DataSource, "Day15.TimeConvert");
            xrtDay16.DataBindings.Add("Text", DataSource, "Day16.TimeConvert");
            xrtDay17.DataBindings.Add("Text", DataSource, "Day17.TimeConvert");
            xrtDay18.DataBindings.Add("Text", DataSource, "Day18.TimeConvert");
            xrtDay19.DataBindings.Add("Text", DataSource, "Day19.TimeConvert");
            xrtDay20.DataBindings.Add("Text", DataSource, "Day20.TimeConvert");
            xrtDay21.DataBindings.Add("Text", DataSource, "Day21.TimeConvert");
            xrtDay22.DataBindings.Add("Text", DataSource, "Day22.TimeConvert");
            xrtDay23.DataBindings.Add("Text", DataSource, "Day23.TimeConvert");
            xrtDay24.DataBindings.Add("Text", DataSource, "Day24.TimeConvert");
            xrtDay25.DataBindings.Add("Text", DataSource, "Day25.TimeConvert");
            xrtDay26.DataBindings.Add("Text", DataSource, "Day26.TimeConvert");
            xrtDay27.DataBindings.Add("Text", DataSource, "Day27.TimeConvert");
            xrtDay28.DataBindings.Add("Text", DataSource, "Day28.TimeConvert");
            xrtDay29.DataBindings.Add("Text", DataSource, "Day29.TimeConvert");
            xrtDay30.DataBindings.Add("Text", DataSource, "Day30.TimeConvert");
            xrtDay31.DataBindings.Add("Text", DataSource, "Day31.TimeConvert");
            totalOverTimeDay.DataBindings.Add("Text", DataSource, "totalOverTimeDay");
            totalOverTimeNight.DataBindings.Add("Text", DataSource, "totalOverTimeNight");
            totalOverTimeHoliday.DataBindings.Add("Text", DataSource, "totalOverTimeHoliday");
            totalOverTimeWeekend.DataBindings.Add("Text", DataSource, "totalOverTimeWeekend");
            totalOverTimeDay.DataBindings.Add("Text", DataSource, "totalOverTimeDay");
            TotalAllOverTime.DataBindings.Add("Text", DataSource, "TotalAllOverTime");            
        }

        /// <summary>
        /// Set color Saturday and Sunday
        /// </summary>
        /// <param name="timeSheetReportId"></param>
        /// <param name="month"></param>
        /// <param name="year"></param>
        private void SetColorByDay(int timeSheetReportId, int month, int year)
        {
        ...
        private void InitializeComponent()
        {
            ...
            this.totalOverTimeDay = new DevExpress.XtraReports.UI.XRTableCell();
            this.totalOverTimeNight = new DevExpress.XtraReports.UI.XRTableCell();
            this.totalOverTimeHoliday = new DevExpress.XtraReports.UI.XRTableCell();
            this.totalOverTimeWeekend = new DevExpress.XtraReports.UI.XRTableCell();
            this.TotalAllOverTime = new DevExpress.XtraReports.UI.XRTableCell();
            ...
            this.xrDetailRow1});
            this.tblDetail.SizeF = new System.Drawing.SizeF(955.5417F, 25F);
            ...
            this.xrtDay30,
            this.xrtDay31,
            this.totalOverTimeDay,
            this.totalOverTimeNight,
            this.totalOverTimeHoliday,
            this.totalOverTimeWeekend,
            this.TotalAllOverTime});
            ...
            // EmployeeCode
            // 
            this.EmployeeCode.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.EmployeeCode.Name = "EmployeeCode";
            this.EmployeeCode.StylePriority.UseBorders = false;
            this.EmployeeCode.StylePriority.UseTextAlignment = false;
            this.EmployeeCode.Text = " ";
            this.EmployeeCode.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.EmployeeCode.Weight = 0.47083355869305876D;
            // 
            // xrTableCellFullName
            // 
            ...
            this.xrTableCellFullName.Weight = 0.56458350226562715D;
            // 
            // xrtDay1
            // 
            ...
            this.xrtDay27.Weight = 0.22969999312690712D;
            // 
            // xrtDay28
            // 
            ...
            this.xrtDay28.Weight = 0.23030000687309285D;
            // 
            // xrtDay29
            // 
            ...
            // totalOverTimeDay
            // 
            this.totalOverTimeDay.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.totalOverTimeDay.Name = "totalOverTimeDay";
            this.totalOverTimeDay.StylePriority.UseBorders = false;
            this.totalOverTimeDay.StylePriority.UseTextAlignment = false;
            this.totalOverTimeDay.Text = " ";
            this.totalOverTimeDay.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.totalOverTimeDay.Weight = 0.23000000000000004D;
            // 
            // totalOverTimeNight
            // 
            this.totalOverTimeNight.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.totalOverTimeNight.Name = "totalOverTimeNight";
            this.totalOverTimeNight.StylePriority.UseBorders = false;
            this.totalOverTimeNight.StylePriority.UseTextAlignment = false;
            this.totalOverTimeNight.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.totalOverTimeNight.Weight = 0.23000000000000004D;
            // 
            // totalOverTimeHoliday
            // 
            this.totalOverTimeHoliday.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.totalOverTimeHoliday.Name = "totalOverTimeHoliday";
            this.totalOverTimeHoliday.StylePriority.UseBorders = false;
            this.totalOverTimeHoliday.StylePriority.UseTextAlignment = false;
            this.totalOverTimeHoliday.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.totalOverTimeHoliday.Weight = 0.23000000000000004D;
            // 
            // totalOverTimeWeekend
            // 
            this.totalOverTimeWeekend.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.totalOverTimeWeekend.Name = "totalOverTimeWeekend";
            this.totalOverTimeWeekend.StylePriority.UseBorders = false;
            this.totalOverTimeWeekend.StylePriority.UseTextAlignment = false;
            this.totalOverTimeWeekend.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.totalOverTimeWeekend.Weight = 0.23000000000000004D;
            // 
            // TotalAllOverTime
            // 
            this.TotalAllOverTime.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Right) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.TotalAllOverTime.Name = "TotalAllOverTime";
            this.TotalAllOverTime.StylePriority.UseBorders = false;
            this.TotalAllOverTime.StylePriority.UseTextAlignment = false;
            this.TotalAllOverTime.TextAlignment = DevExpress.XtraPrinting.TextAlignment.MiddleCenter;
            this.TotalAllOverTime.Weight = 0.24000000019993004D;
            // 
            // TopMargin
            // 
            ...
            this.xrCellReportName.Text = "Báo cáo tăng ca {0}/{1}";
            ...
            this.xrTableRow11});
            this.tblPageHeader.SizeF = new System.Drawing.SizeF(957.5419F, 60.87508F);
            ...
            // xrTableCellCode
            // 
            this.xrTableCellCode.BorderColor = System.Drawing.Color.DarkGray;
            this.xrTableCellCode.Borders = ((DevExpress.XtraPrinting.BorderSide)(((DevExpress.XtraPrinting.BorderSide.Left | DevExpress.XtraPrinting.BorderSide.Top) 
            | DevExpress.XtraPrinting.BorderSide.Bottom)));
            this.xrTableCellCode.Font = new System.Drawing.Font("Times New Roman", 5F, System.Drawing.FontStyle.Bold);
            this.xrTableCellCode.Name = "xrTableCellCode";
            this.xrTableCellCode.StylePriority.UseBorderColor = false;
            this.xrTableCellCode.StylePriority.UseBorders = false;
            this.xrTableCellCode.StylePriority.UseFont = false;
            this.xrTableCellCode.Text = "Mã NV";
            this.xrTableCellCode.Weight = 0.47083335876464838D;
            // 
            // xrTableCell242
            // 
            ...
            this.xrTableCell242.Text = "Tên NV";
            this.xrTableCell242.Weight = 0.56458328247070311D;
            // 
            // xrTableCell2
            // 
            ...
            // xrlabel_1
            // 
            this.xrlabel_1.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Top | DevExpress.XtraPrinting.BorderSide.Bottom)));
            ...
            // xrlabel_27
            // 
            this.xrlabel_27.Borders = ((DevExpress.XtraPrinting.BorderSide)((DevExpress.XtraPrinting.BorderSide.Top | DevExpress.XtraPrinting.BorderSide.Bottom)));
            ...
            this.xrTableCell55.Text = "29";
            this.xrTableCell55.Weight = 0.0077166723555470093D;
            // 
            // xrTableCell75
            // 
            ...
            this.xrTableCell75.Text = "30";
            this.xrTableCell75.Weight = 0.0077167542674285482D;
            // 
            // xrTableCell42
            // 
            ...
            this.xrTableCell42.Text = "31";
            this.xrTableCell42.Weight = 0.0077167747453989318D;
            // 
            // xrTableCell5
            // 
            ...
            this.xrTableCell5.Text = "Tổng thời gian tăng ca ngày";
            ...
            this.xrTableCell1.Text = "Tổng thời gian tăng ca đêm";
            this.xrTableCell1.Weight = 0.2300006103515635D;
            // 
            // xrTableCell3
            // 
            ...
            this.xrTableCell3.Text = "Tổng thời gian tăng ca ngày lễ";
            this.xrTableCell3.Weight = 0.2300006103515635D;
            // 
            // xrTableCell4
            // 
            ...
            this.xrTableCell4.Text = "Tổng thời gian tăng ca ngày nghỉ";
            this.xrTableCell4.Weight = 0.2300006103515635D;
            // 
            // xrTableCell6
            // 
            ...
            this.xrTableCell6.Text = "Tổng thời gian tăng ca theo tháng";
            this.xrTableCell6.Weight = 0.24000001994988116D;
            // 
            // xrTableCell38
            // 
            ...
            this.xrTableCell38.Weight = 0.020000590401682235D;
            // 
            // formattingRule1
            // 
