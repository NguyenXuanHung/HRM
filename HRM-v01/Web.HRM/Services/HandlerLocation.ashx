<%@ WebHandler Language="C#" Class="Web.HRM.Services.HandlerLocation" %>
...
namespace Web.HRM.Services
{
    public class HandlerLocation : Core.Framework.BaseControl.BaseHandler, IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var pageResult =
                CatalogLocationController.GetPaging(_keyword, _parentId, _group, CatalogStatus.Active, false, _order,
                    Start, Limit);
            // response
