<%@ WebHandler Language="C#" Class="Web.HRM.Services.HandlerCatalogBase" %>
...
{
    public class HandlerCatalogBase : Core.Framework.BaseControl.BaseHandler, IHttpHandler
    {
        // init default value        
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            {
                _objName = context.Request["objName"];
            }
            ...
            if(!string.IsNullOrEmpty(_objName))
                // select from table
                pageResult = CatalogController.GetPaging(_objName, _keyword, _group, _status, false, _order, _start, _limit);
            // response
