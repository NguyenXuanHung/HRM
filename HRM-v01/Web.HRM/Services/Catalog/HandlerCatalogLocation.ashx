<%@ WebHandler Language="C#" Class="Web.HRM.Services.HandlerCatalogLocation" %>
...
{
    public class HandlerCatalogLocation : Core.Framework.BaseControl.BaseHandler, IHttpHandler
    {
        // init default value        
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            // init page result
            var pageResult = CatalogLocationController.GetPaging(_keyword, _parentId, _group, _status, false, _order, _start, _limit);
