<%@ WebHandler Language="C#" Class="Web.HRM.Services.HandlerCatalogGroupQuantumGrade" %>
...
{
    public class HandlerCatalogGroupQuantumGrade : Core.Framework.BaseControl.BaseHandler, IHttpHandler
    {
        // init default value        
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            // init page result
            var pageResult = CatalogGroupQuantumGradeController.GetPaging(_keyword, _groupQuantumId, _group, _status, false, _order, _start, _limit);
            // response
