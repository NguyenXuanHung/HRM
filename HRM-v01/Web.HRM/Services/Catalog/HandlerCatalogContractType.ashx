<%@ WebHandler Language="C#" Class="Web.HRM.Services.HandlerCatalogContractType" %>
...
{
    public class HandlerCatalogContractType : Core.Framework.BaseControl.BaseHandler, IHttpHandler
    {
        // init default value        
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            // init page result
            var pageResult = CatalogContractTypeController.GetPaging(_keyword, _group, _status, false, _order, _start, _limit);
            // response
