<%@ WebHandler Language="C#" Class="Web.HRM.Services.HandlerCatalogBasicSalary" %>
...
{
    public class HandlerCatalogBasicSalary : Core.Framework.BaseControl.BaseHandler, IHttpHandler
    {
        // init default value        
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            // init page result
            var pageResult = CatalogBasicSalaryController.GetPaging(_keyword, _group, _status, false, _order, _start, _limit);
