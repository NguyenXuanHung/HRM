<%@ WebHandler Language="C#" Class="Web.HRM.Services.HandlerCatalogGroupQuantum" %>
...
{
    public class HandlerCatalogGroupQuantum : Core.Framework.BaseControl.BaseHandler, IHttpHandler
    {
        // init default value        
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            // init page result
            var pageResult = CatalogGroupQuantumController.GetPaging(_keyword, _group, _status, false, _order, _start, _limit);
            // response
