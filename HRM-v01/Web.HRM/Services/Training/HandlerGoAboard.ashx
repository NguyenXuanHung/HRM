<%@ WebHandler Language="C#" Class="Web.HRM.Services.HandlerGoAboard" %>
...
{
    public class HandlerGoAboard : Core.Framework.BaseControl.BaseHandler, IHttpHandler
    {
        // init variables      
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            var pageResult = GoAboardController.GetPaging(_keyword, departmentIds, null, nationId, _fromDate, _toDate, _order, _start, _limit);
