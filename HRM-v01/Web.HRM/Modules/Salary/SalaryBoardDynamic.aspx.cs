...
namespace Web.HRM.Modules.Salary
{
    ...
    {
        // TODO : Chuyển về file constant + viết comment
            ...
            try
            {
                ...
                foreach (var item in selecteds)
                {
                    ...
                    if (salaryBoard != null)
                    {
                        ...
                        //Lấy công chuẩn
                        var timeSheetReport = hr_TimeSheetReportServices.GetById(salaryBoard.TimeSheetReportId);
                        if (timeSheetReport != null)
                        {
                            salaryBoard.WorkStandard = timeSheetReport.WorkInMonth;
                        }
                    }
                    //Cập nhật vào bảng lương động
            ...
            try
            {
                ...
                if (property != null)
                {
                    ...
                    else
                    {
                        ...
                        if (!double.TryParse(txtValueAdjustment.Text, out var result) || result < 0)
                        {
