<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.Setting.SchedulerHistoryManagement" Codebehind="SchedulerHistoryManagement.aspx.cs" %>
<%@ Register src="/Modules/UC/ResourceCommon.ascx" tagName="ResourceCommon" tagPrefix="CCVC"%>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<%@ Register Src="~/Modules/UC/SchedulerLogManagement.ascx" TagPrefix="uc1" TagName="SchedulerLogManagement" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <uc1:SchedulerLogManagement runat="server" ID="ucSchedulerLogManagement" ChiChonMotCanBo="false" DisplayWorkingStatus="TatCa" />
