<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.TurnoverToManagement" Codebehind="TurnoverToManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputTurnoverTo = function () {
            ...
            if (dfExpireDate.getValue() == '' || dfExpireDate.getValue().trim == '' || dfExpireDate.getValue() == null) {
                alert('Bạn chưa nhập thời hạn luân chuyển!');
                return false;
            }
        ...
        var checkUpdateTurnoverTo = function () {
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="vp" runat="server" HideBorders="true">
                <Items>
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridTurnoverTo" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdTurnoverTo.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeTurnoverTo">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column Header="Đơn vị công tác cũ" Width="160" DataIndex="OldDepartment" />
                                        <ext:Column Header="Cơ quan luân chuyển" Width="170" DataIndex="SourceDepartment" />
            ...
            <ext:Window runat="server" Title="Tạo quyết định luân chuyển đến" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdTurnoverTo"
                                                ...
                                                <Items>
                                                    <ext:Container runat="server" ID="Container2" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfExpireDate" CtCls="requiredData" FieldLabel="Thời hạn luân chuyển<span style='color:red'>*</span>" Disabled="true"
                                                            ...
                                                            <ext:DateField runat="server" ID="dfEffectiveDate" CtCls="requiredData" FieldLabel="Ngày hiệu lực<span style='color:red'>*</span>" Disabled="true"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtOldDepartment" FieldLabel="Đơn vị công tác cũ" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtSourceDepartment" FieldLabel="Cơ quan luân chuyển" AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnCapNhat" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputTurnoverTo();" />
                        </Listeners>
                        <DirectEvents>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdTurnoverTo.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật luân chuyển đến" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateTurnoverTo"
                Modal="true" Constrain="true" Height="500">
                <Items>
                                                    ...
                                                    <ext:Container runat="server" ID="Container12" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            <ext:TextField runat="server" ID="txtUpdateShortDecision" FieldLabel="Trích yếu quyết định"
                                                                AnchorHorizontal="100%"/>
                                                             <ext:DateField runat="server" ID="dfUpdateExpireDate" CtCls="requiredData" FieldLabel="Thời hạn luân chuyển<span style='color:red'>*</span>" Disabled="true"
                                                                Editable="true" MaskRe="/[0-9|/]/" Format="dd/MM/yyyy" AnchorHorizontal="50%">
                                                                <Triggers>
                                                                    <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                                </Triggers>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfUpdateEffectiveDate" CtCls="requiredData" FieldLabel="Ngày hiệu lực<span style='color:red'>*</span>" Disabled="true"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtUpdateOldDepartment" FieldLabel="Đơn vị công tác cũ" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtUpdateSourceDepartment" FieldLabel="Cơ quan luân chuyển" AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateAndSave" Text="Cập nhật và đóng lại" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkUpdateTurnoverTo();" />
                        </Listeners>
                        <DirectEvents>
                            <Click OnEvent="InsertOrUpdate">
                                <EventMask ShowMask="true" Msg="Đang lưu dữ liệu. Vui lòng chờ..." />
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateTurnoverTo.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
