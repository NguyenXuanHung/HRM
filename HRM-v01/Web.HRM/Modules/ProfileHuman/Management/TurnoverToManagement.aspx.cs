...
{
    public partial class TurnoverToManagement : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!ExtNet.IsAjaxRequest)
            {
                ...
                if (btnEdit.Visible)
                {
                    gridTurnoverTo.Listeners.RowDblClick.Handler +=
                        " if(CheckSelectedRows(gridTurnoverTo)){btnUpdateAndSave.show();}";
                }
            }
        }
        ...
        protected void InsertOrUpdate(object sender, DirectEventArgs e)
        {
            ...
            if (e.ExtraParams["Close"] != "True")
            {
                ...
                gridTurnoverTo.Reload();
                return;
            }

            //hide window
            wdTurnoverTo.Hide();
            wdUpdateTurnoverTo.Hide();
        ...
        protected void EditMoveToClick(object sender, DirectEventArgs e)
        {
            ...
            txtUpdateOldDepartment.Text = business.OldDepartment;
        ...
        private void Insert()
        {
            try
            {
                ...
                var business = new hr_BusinessHistory
                {
                    ...
                    OldDepartment = txtOldDepartment.Text,
        ...
        private void Update()
        {
            try
            {
                ...
                business.OldDepartment = txtUpdateOldDepartment.Text;
