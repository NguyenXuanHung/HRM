...
{
    public partial class RetirementManagement : BasePage
    {
        ...
        private void Insert()
        {
            try
            {
                ...
                var currentDepartment = hdfIsCurrentDepartment.Text == @"0" ? cbxCurrentDepartment.Text : cbxCurrentDepartment.SelectedItem.Text;
        ...
        private void Update()
        {
            try
            {
                ...
                var curDepartment = hdfIsUpdateCurrentDepartment.Text == @"0" ? cbxUpdateCurrentDepartment.Text : cbxUpdateCurrentDepartment.SelectedItem.Text;
                ...
                business.CurrentDepartment = curDepartment.Trim('-');
