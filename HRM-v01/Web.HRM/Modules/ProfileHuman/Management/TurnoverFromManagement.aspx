<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.TurnoverFromManagement" Codebehind="TurnoverFromManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputTurnoverFrom = function () {
        ...
        var checkUpdateTurnoverFrom = function () {
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="vp" runat="server" HideBorders="true">
                <Items>
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridTurnoverFrom" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdTurnoverFrom.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeTurnoverFrom">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
            ...
            <ext:Window runat="server" Title="Tạo quyết định luân chuyển đi" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdTurnoverFrom"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfEffectiveDate" CtCls="requiredData" FieldLabel="Ngày hiệu lực<span style='color:red'>*</span>" Disabled="true"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtCurrentDepartment" FieldLabel="Đơn vị đang công tác" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtSourceDepartment" FieldLabel="Cơ quan ra quyết định" AnchorHorizontal="100%" Hidden="true"/>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtNewPosition" FieldLabel="Chức vụ luân chuyển"
                                                                AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnCapNhat" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputTurnoverFrom();" />
                        </Listeners>
                        <DirectEvents>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdTurnoverFrom.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật luân chuyển đi" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateTurnoverFrom"
                Modal="true" Constrain="true" Height="500">
                <Items>
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfUpdateEffectiveDate" CtCls="requiredData" FieldLabel="Ngày hiệu lực<span style='color:red'>*</span>" Disabled="true"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtUpdateCurrentDepartment" FieldLabel="Đơn vị đang công tác" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtUpdateSourceDepartment" FieldLabel="Cơ quan ra quyết định" AnchorHorizontal="100%" Hidden="true"/>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtUpdateNewPosition" FieldLabel="Chức vụ luân chuyển"
                                                                AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateAndSave" Text="Cập nhật và đóng lại" Icon="Disk">
                         <Listeners>
                            <Click Handler="return checkUpdateTurnoverFrom();" />
                        </Listeners>
                        <DirectEvents>
                            <Click OnEvent="InsertOrUpdate">
                                <EventMask ShowMask="true" Msg="Đang lưu dữ liệu. Vui lòng chờ..." />
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateTurnoverFrom.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
