<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.WorkProcessManagement" Codebehind="WorkProcessManagement.aspx.cs" %>
    ...
    <form id="form1" runat="server">
        <div>
                                ...
                                <Items>
                                    <ext:FieldSet runat="server" ID="FieldSet5" Title="Thông tin quyết định mới" Layout="FormLayout"
                                        ...
                                        <Items>
                                            ...
                                            <ext:TextField runat="server" ID="txtPhuCapChucVuMoi" FieldLabel="Phụ cấp chức vụ" AnchorHorizontal="100%" MaxLength="15" MaskRe="/[0-9.,]/">
                                            </ext:TextField>
            ...
            <ext:Window Modal="true" Hidden="true" runat="server" Layout="BorderLayout" ID="wdShowReport"
                ...
                <Listeners>
                    <BeforeShow Handler="#{pnReportPanel}.remove(0);addHomePage(#{pnReportPanel},'Homepage','DecisionAppointmentEmployee.html?prkey='+#{hdfKeyRecord}.getValue(), '<asp:Literal runat=\'server\' Text=\'Báo cáo hồ sơ cán bộ\' />')" />
