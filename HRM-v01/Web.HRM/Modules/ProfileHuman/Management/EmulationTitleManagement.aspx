<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.EmulationTitleManagement" Codebehind="EmulationTitleManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputTransfer = function () {
        ...
        var checkUpdateTransfer = function () {
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="vp" runat="server" HideBorders="true">
                <Items>
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridEmulation" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdEmulation.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                            <ext:Button runat="server" ID="btnEdit" Text="Sửa" Icon="Pencil" Disabled="true">

                                                <DirectEvents>
                                                    <Click OnEvent="EditEmulationClick">
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeTranfer">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column Header="Đơn vị đang công tác" Width="140" DataIndex="CurrentDepartment" />
                                        ...
                                        <ext:Column Header="Số tiền" Width="170" DataIndex="Money" >
                                            <Renderer Fn="RenderVND" />
                                        </ext:Column>
                                        <ext:Column Header="Người ký" Width="180" DataIndex="DecisionMaker"/>
                                        <ext:Column Header="Chức vụ người ký" Width="120" Align="Left" DataIndex="DecisionPosition" />
                                        <ext:Column Header="Cơ quan phong tặng" Width="120" Align="Left" DataIndex="SourceDepartment" />
            ...
            <ext:Window runat="server" Title="Tạo quyết định danh hiệu thi đua" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdEmulation"
                                    ...
                                    <ext:Container runat="server" ID="Ctn12" Layout="FormLayout" ColumnWidth="0.5">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbxChonCanBo" CtCls="requiredData" ValueField="Id" DisplayField="FullName"
                                                ...
                                                <Listeners>
                                                    <Select Handler="hdfChonCanBo.setValue(cbxChonCanBo.getValue());txtDecisionNumber.enable();dfDecisionDate.enable();" />
                                            ...
                                            <ext:Container runat="server" ID="Container18" Layout="ColumnLayout" AnchorHorizontal="100%"
                                                ...
                                                <Items>
                                                    ...
                                                    <ext:Container runat="server" ID="Container20" Layout="FormLayout" ColumnWidth="0.5"
                                                        LabelWidth="107">
                                                        <Items>
                                                            <ext:DateField runat="server" ID="dfDecisionDate" CtCls="requiredData" FieldLabel="Ngày ký<span style='color:red'>*</span>" Disabled="true"
                                                        ...
                                                        <Items>
                                                            <ext:TextField runat="server" ID="txtShortDecision" FieldLabel="Trích yếu quyết định"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtCurrentDepartment" FieldLabel="Đơn vị đang công tác" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtEmulationTitle" FieldLabel="Danh hiệu công nhận" AnchorHorizontal="100%"/>
                                                            ...
                                                            <ext:ComboBox runat="server" ID="cbxDestDepartment" DisplayField="Name" FieldLabel="Đơn vị nơi đến"
                                                                ValueField="Id" AnchorHorizontal="100%" TabIndex="3" Editable="true" Hidden="true"
                                                            ...
                                                            <ext:NumberField runat="server" ID="txtMoney" FieldLabel="Số tiền thưởng" MaskRe="/[0-9.,]/" AnchorHorizontal="100%"/>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtSourceDepartment" FieldLabel="Cơ quan phong tặng" AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnCapNhat" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputTransfer();" />
                        </Listeners>
                        <DirectEvents>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdEmulation.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật danh hiệu thi đua" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateEmulation"
                Modal="true" Constrain="true" Height="450">
                <Items>
                                            ...
                                            <ext:Container runat="server" ID="Container8" Layout="ColumnLayout" AnchorHorizontal="100%"
                                                ...
                                                <Items>
                                                    ...
                                                    <ext:Container runat="server" ID="Container10" Layout="FormLayout" ColumnWidth="0.5"
                                                        LabelWidth="107">
                                                        <Items>
                                                            <ext:DateField runat="server" ID="dfUpdateDecisionDate" CtCls="requiredData" FieldLabel="Ngày ký<span style='color:red'>*</span>" Disabled="true"
                                                                Editable="true" MaskRe="/[0-9|/]/" Format="dd/MM/yyyy" AnchorHorizontal="100%">
                                                            </ext:DateField>
                                                        </Items>
                                                    </ext:Container>
                                                        ...
                                                        <Items>
                                                            <ext:TextField runat="server" ID="txtUpdateShortDecision" FieldLabel="Trích yếu quyết định"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtUpdateCurrentDepartment" FieldLabel="Đơn vị đang công tác" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtUpdateEmulationTitle" FieldLabel="Danh hiệu công nhận" AnchorHorizontal="100%"/>
                                                            ...
                                                            <ext:ComboBox runat="server" ID="cbxUpdateDestDepartment" DisplayField="Name" FieldLabel="Đơn vị nơi đến"
                                                                ValueField="Id" AnchorHorizontal="100%" TabIndex="3" Editable="true" Hidden="true"
                                                                ItemSelector="div.list-item" MinChars="1" EmptyText="Gõ để tìm kiếm" LoadingText="Đang tải dữ liệu..."
                                                                EnableKeyEvents="true" StoreID="storeDepartment">
                                                                <Triggers>
                                                            ...
                                                            <ext:NumberField runat="server" ID="txtUpdateMoney" FieldLabel="Số tiền thưởng" MaskRe="/[0-9.,]/" AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateAndSave" Text="Cập nhật và đóng lại" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkUpdateTransfer();" />
                        </Listeners>
                        <DirectEvents>
                            <Click OnEvent="InsertOrUpdate">
                                <EventMask ShowMask="true" Msg="Đang lưu dữ liệu. Vui lòng chờ..." />
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateEmulation.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
