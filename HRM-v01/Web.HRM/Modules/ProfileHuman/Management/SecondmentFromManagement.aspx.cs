...
{
    public partial class SecondmentFromManagement : BasePage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if(!ExtNet.IsAjaxRequest)
            {
                ...
                if(btnEdit.Visible)
                {
                    gridSecondmentFrom.Listeners.RowDblClick.Handler +=
                        " if(CheckSelectedRows(gridSecondmentFrom)){btnUpdateAndSave.show();}";
                }
            }
        }
        ...
        protected void InsertOrUpdate(object sender, DirectEventArgs e)
        {
            ...
            //hide window
            wdSecondmentFrom.Hide();
            wdUpdateSecondmentFrom.Hide();

            //reload data
            gridSecondmentFrom.Reload();
            txtDescription.Text = "";
            RM.RegisterClientScriptBlock("resetform1", "ResetFormBusiness();");
