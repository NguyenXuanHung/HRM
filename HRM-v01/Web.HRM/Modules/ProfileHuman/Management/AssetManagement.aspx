<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.AssetManagement" Codebehind="AssetManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputAsset = function () {
            if (hdfEmployeeSelectedId.getValue() === '' || hdfEmployeeSelectedId.getValue().trim == '') {
                alert('Bạn chưa nhập tên cán bộ!');
                return false;
            }
            if (txtAssetName.getValue() == '' || txtAssetName.getValue().trim == '') {
                alert('Bạn chưa nhập tên công cụ!');
                return false;
            }
            if (txtAssetCode.getValue() == '' || txtAssetCode.getValue().trim == '') {
                alert('Bạn chưa nhập mã công cụ!');
                return false;
            }
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="vp" runat="server" HideBorders="true">
                <Items>
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridAsset" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdAsset.show();wdAsset.setTitle('Tạo mới thông tin công cụ cấp phát');cbxSelectedEmployee.enable();btnUpdate.hide();btnUpdateNew.show();btnUpdateClose.show();
                                ...
                                <Store>
                                    <ext:Store ID="storeAsset" runat="server" GroupField="FullName">
                                        ...
                                        <BaseParams>
                                            <ext:Parameter Name="handlers" Value="Asset" />
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column Header="Số hiệu CBCC" Width="150" Align="Left" Locked="true" DataIndex="EmployeeCode" />
                                         <ext:Column ColumnID="AssetName" Header="Tên công cụ, dụng cụ" Width="200" DataIndex="AssetName"/>
                                        <ext:Column ColumnID="AssetCode" Header="Mã số" Width="170" DataIndex="AssetCode"/>
                                        ...
                                        <ext:Column ColumnID="Status" Header="Chất lượng" Width="150" DataIndex="Status" />
                                        <ext:DateColumn ColumnID="ReceiveDate" Header="Ngày nhận" Width="100" DataIndex="ReceiveDate" Format="dd/MM/yyyy"/>  
            ...
            <ext:Window runat="server" Title="Tạo mới thông tin công cụ cấp phát" Resizable="true" Layout="FormLayout"
                Padding="6" Width="500" Hidden="true" Icon="UserTick" ID="wdAsset"
                ...
                <Items>
                    ...
                    <ext:TextField runat="server" ID="txtAssetName" CtCls="requiredData" FieldLabel="Tên tài sản<span style='color:red;'>*</span>"
                        AnchorHorizontal="100%" />
                    <ext:TextField runat="server" ID="txtAssetCode" CtCls="requiredData" FieldLabel="Mã số<span style='color:red;'>*</span>" 
                        AnchorHorizontal="100%"/>
                    <ext:TextField runat="server" ID="txtQuantity" AnchorHorizontal="100%" MaskRe="/[0-9]/" FieldLabel="Số lượng" />
                    <ext:TextField runat="server" ID="txtUnitCode" Editable="true" AnchorHorizontal="100%" FieldLabel="Đơn vị tính"/>
                    <ext:TextField runat="server" FieldLabel="Chất lượng" AnchorHorizontal="100%" ID="txtStatus" />  
                    <ext:DateField ID="dfReceiveDate" runat="server" FieldLabel="Ngày nhận" AnchorHorizontal="100%"
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateNew" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputAsset();" />
                        </Listeners>
                        <DirectEvents>
