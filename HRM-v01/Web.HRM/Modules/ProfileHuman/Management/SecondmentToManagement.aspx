<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.SecondmentToManagement" Codebehind="SecondmentToManagement.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="vp" runat="server" HideBorders="true">
                <Items>
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridSecondmentTo" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdSecondmentTo.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeSecondmentTo">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column Header="Chức vụ biệt phái đến" Width="140" Align="Left" DataIndex="NewPosition" />
            ...
            <ext:Window runat="server" Title="Tạo quyết định biệt phái đến" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdSecondmentTo"
                                                ...
                                                <Items>
                                                    <ext:Container runat="server" ID="Container2" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtNewPosition" FieldLabel="Chức vụ biệt phái đến" 
                                                                AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdSecondmentTo.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật biệt phái đến" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateSecondmentTo"
                Modal="true" Constrain="true" Height="500">
                <Items>
                                                ...
                                                <Items>
                                                    <ext:Container runat="server" ID="Container12" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtUpdateNewPosition" FieldLabel="Chức vụ biệt phái đến" 
                                                                AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateSecondmentTo.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
