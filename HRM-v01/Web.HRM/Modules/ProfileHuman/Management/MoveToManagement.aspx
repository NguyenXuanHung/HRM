<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.MoveToManagement" Codebehind="MoveToManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        ...
        var checkUpdateMoveTo = function () {
...
<body>
    <form id="form1" runat="server">
        <div>
                    ...
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridMoveTo" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdMoveTo.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeMoveTo">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column Header="Đơn vị công tác cũ" Width="120" DataIndex="OldDepartment" />
                                        <ext:Column Header="Cơ quan điều động đến" Width="170" DataIndex="SourceDepartment" />
            ...
            <ext:Window runat="server" Title="Tạo quyết định điều động đến" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdMoveTo"
                                                    ...
                                                    <ext:Container runat="server" ID="Container2" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfEffectiveDate" CtCls="requiredData" FieldLabel="Ngày hiệu lực<span style='color:red'>*</span>" Disabled="true"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtOldDepartment" FieldLabel="Đơn vị công tác cũ" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtSourceDepartment" FieldLabel="Cơ quan điều động đến" AnchorHorizontal="100%"/>
                                                            ...
                                                            <ext:ComboBox runat="server" ID="cbxDestDepartment" DisplayField="Name" FieldLabel="Đơn vị đến"
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnCapNhat" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputMoveTo();" />
                        </Listeners>
                        <DirectEvents>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdMoveTo.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật điều động đến" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateMoveTo"
                Modal="true" Constrain="true" Height="450">
                <Items>
                                                    ...
                                                    <ext:Container runat="server" ID="Container12" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfUpdateEffectiveDate" CtCls="requiredData" FieldLabel="Ngày hiệu lực<span style='color:red'>*</span>" Disabled="true"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtUpdateOldDepartment" FieldLabel="Đơn vị công tác cũ" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtUpdateSourceDepartment" FieldLabel="Cơ quan điều động đến" AnchorHorizontal="100%"/>
                                                            ...
                                                            <ext:ComboBox runat="server" ID="cbxUpdateDestDepartment" DisplayField="Name" FieldLabel="Đơn vị đến"
                                                                ValueField="Id" AnchorHorizontal="100%" TabIndex="3" Editable="true"
                                                                ItemSelector="div.list-item" MinChars="1" EmptyText="Gõ để tìm kiếm" LoadingText="Đang tải dữ liệu..."
                                                                EnableKeyEvents="true" StoreID="storeDepartment">
                                                                <Triggers>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateAndSave" Text="Cập nhật và đóng lại" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkUpdateMoveTo();" />
                        </Listeners>
                        <DirectEvents>
                            <Click OnEvent="InsertOrUpdate">
                                <EventMask ShowMask="true" Msg="Đang lưu dữ liệu. Vui lòng chờ..." />
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateMoveTo.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
