<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.DismissalManagement" Codebehind="DismissalManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputDismissal = function () {
        ...
        var checkUpdateDismissal = function () {
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="vp" runat="server" HideBorders="true">
                <Items>
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridDismissal" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdDismissal.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeDismissal">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
            ...
            <ext:Window runat="server" Title="Tạo quyết định miễn nhiệm, bãi nhiệm" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdDismissal"
                                    ...
                                    <ext:Container runat="server" ID="Ctn12" Layout="FormLayout" ColumnWidth="0.5">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbxChonCanBo" CtCls="requiredData" ValueField="Id" DisplayField="FullName"
                                                ...
                                                ItemSelector="div.search-item" MinChars="1" EmptyText="Nhập tên để tìm kiếm" LabelWidth="450"
                                     ...
                                     <ext:Container runat="server" ID="Ctn13" Layout="FormLayout" ColumnWidth="0.5">
                                        <Items>
                                            <ext:TextField runat="server" ID="txtCurrentPosition" FieldLabel="Chức vụ" AnchorHorizontal="100%" Hidden="true"/>
                                        </Items>
                                    </ext:Container>
                                </Items>
                            </ext:Container>
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfEffectiveDate" CtCls="requiredData" FieldLabel="Ngày hiệu lực<span style='color:red'>*</span>" Disabled="true"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtCurrentDepartment" FieldLabel="Đơn vị đang công tác" 
                                                                AnchorHorizontal="100%"/>
                                                             <ext:TextField runat="server" ID="txtNewPosition" FieldLabel="Chức vụ miễn nhiệm, bãi nhiệm" 
                                                                AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnCapNhat" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputDismissal();" />
                        </Listeners>
                        <DirectEvents>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdDismissal.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật miễn nhiệm, bãi nhiệm" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateDismissal"
                Modal="true" Constrain="true" Height="450">
                <Items>
                            ...
                            <ext:Container runat="server" ID="Container3" Layout="ColumnLayout" Height="25" AnchorHorizontal="100%">
                                <Items>
                                    ...
                                    <ext:Container runat="server" ID="Container5" Layout="FormLayout" ColumnWidth="0.5">
                                        <Items>
                                            <ext:TextField runat="server" ID="txtUpdateCurrentPosition" FieldLabel="Chức vụ" AnchorHorizontal="100%" Hidden="true"/>
                                        </Items>
                                    </ext:Container>
                                </Items>
                            </ext:Container>
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfUpdateEffectiveDate" CtCls="requiredData" FieldLabel="Ngày hiệu lực<span style='color:red'>*</span>" Disabled="true"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtUpdateCurrentDepartment" FieldLabel="Đơn vị đang công tác" 
                                                                AnchorHorizontal="100%"/>
                                                            <ext:TextField runat="server" ID="txtUpdateNewPosition" FieldLabel="Chức vụ miễn nhiệm, bãi nhiệm" 
                                                                AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateAndSave" Text="Cập nhật và đóng lại" Icon="Disk">
                         <Listeners>
                            <Click Handler="return checkUpdateDismissal();" />
                        </Listeners>
                        <DirectEvents>
                            <Click OnEvent="InsertOrUpdate">
                                <EventMask ShowMask="true" Msg="Đang lưu dữ liệu. Vui lòng chờ..." />
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateDismissal.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
