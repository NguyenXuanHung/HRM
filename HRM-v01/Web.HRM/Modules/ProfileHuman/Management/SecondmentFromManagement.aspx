<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.SecondmentFromManagement" Codebehind="SecondmentFromManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputSecondment = function () {
            ...
            if (dfExpireDate.getValue() == '' || dfExpireDate.getValue().trim == '' || dfExpireDate.getValue() == null) {
                alert('Bạn chưa nhập thời hạn biệt phái!');
                return false;
            }
        ...
        var checkUpdateSecondment = function () {
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="vp" runat="server" HideBorders="true">
                <Items>
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridSecondmentFrom" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdSecondmentFrom.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeSecondmentFrom">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column Header="Chức vụ biệt phái" Width="170" DataIndex="NewPosition" />
            ...
            <ext:Window runat="server" Title="Tạo quyết định biệt phái đi" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdSecondmentFrom"
                                                    ...
                                                    <ext:Container runat="server" ID="Container2" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            <ext:TextField runat="server" ID="txtShortDecision" FieldLabel="Trích yếu quyết định"
                                                             ...
                                                             <ext:DateField runat="server" ID="dfExpireDate" CtCls="requiredData" FieldLabel="Thời hạn biệt phái<span style='color:red'>*</span>" Disabled="true"
                                                            ...
                                                            <ext:TextField runat="server" ID="txtNewPosition" FieldLabel="Chức vụ biệt phái"
                                                                AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnCapNhat" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputSecondment();" />
                        </Listeners>
                        <DirectEvents>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdSecondmentFrom.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật biệt phái đi" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateSecondmentFrom"
                Modal="true" Constrain="true" Height="500">
                <Items>
                                                    ...
                                                    <ext:Container runat="server" ID="Container12" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            <ext:TextField runat="server" ID="txtUpdateShortDecision" FieldLabel="Trích yếu quyết định"
                                                                AnchorHorizontal="100%"/>
                                                            <ext:DateField runat="server" ID="dfUpdateExpireDate" CtCls="requiredData" FieldLabel="Thời hạn biệt phái<span style='color:red'>*</span>" Disabled="true"
                                                                Editable="true" MaskRe="/[0-9|/]/" Format="dd/MM/yyyy" AnchorHorizontal="50%">
                                                                <Triggers>
                                                                    <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                                </Triggers>
                                                            ...
                                                            <ext:ComboBox runat="server" ID="cbxUpdateDestDepartment" DisplayField="Name" FieldLabel="Đơn vị đến"
                                                             ...
                                                             <ext:TextField runat="server" ID="txtUpdateNewPosition" FieldLabel="Chức vụ biệt phái" AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateAndSave" Text="Cập nhật và đóng lại" Icon="Disk">
                         <Listeners>
                            <Click Handler="return checkUpdateSecondment();" />
                        </Listeners>
                        <DirectEvents>
                            <Click OnEvent="InsertOrUpdate">
                                <EventMask ShowMask="true" Msg="Đang lưu dữ liệu. Vui lòng chờ..." />
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateSecondmentFrom.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
