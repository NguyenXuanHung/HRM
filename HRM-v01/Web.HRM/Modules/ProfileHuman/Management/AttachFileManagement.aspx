<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.AttachFileManagement" Codebehind="AttachFileManagement.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Hidden runat="server" ID="hdfAttachFilePathConst" />
                    ...
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridAttachFile" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdAttachFile.show();wdAttachFile.setTitle('Tạo mới thông tin tệp tin đính kèm');cbxSelectedEmployee.enable();btnUpdate.hide();btnUpdateNew.show();btnUpdateClose.show();
                                ...
                                <Listeners>
                                    <Command Handler="Ext.net.DirectMethods.DownloadAttach(hdfAttachFilePathConst.getValue() + record.data.URL, {isUpload: true});" />
                                </Listeners>
                                <BottomBar>
