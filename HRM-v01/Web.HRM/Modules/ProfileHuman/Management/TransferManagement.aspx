<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.TransferManagement" CodeBehind="TransferManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputTransfer = function () {
            ...
            if (dfLeaveDate.hidden == false && !dfLeaveDate.getValue()) {
                alert('Bạn chưa nhập ngày tháng đi!');
                return false;
            }
            if (txtLeaveProject.hidden == false && !txtLeaveProject.getValue()) {
                alert('Bạn chưa nhập dự án đi!');
                return false;
            }
            return true;
        }
        var checkUpdateTransfer = function () {
            ...
            if (dfUpdateLeaveDate.hidden == false && !dfUpdateLeaveDate.getValue()) {
                alert('Bạn chưa nhập ngày tháng đi!');
                return false;
            }
            if (txtUpdateLeaveProject.hidden == false && !txtUpdateLeaveProject.getValue()) {
                alert('Bạn chưa nhập dự án đi!');
                return false;
            }
            return true;
...
<body>
    <form id="form1" runat="server">
        <div>
                            ...
                            <ext:GridPanel ID="gridMoveTo" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdTransfer.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeTranfer">
                                        ...
                                        <BaseParams>
                                            ...
                                            <ext:Parameter Name="menuType" Value="hdfMenuType.getValue()" Mode="Raw" />
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column Header="Đơn vị đến" Width="170" DataIndex="DestinationDepartment" />
            ...
            <ext:Window runat="server" Title="Tạo quyết định thuyên chuyển, điều chuyển" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdTransfer"
                Modal="true" Constrain="true" Height="490">
                <Items>
                                    ...
                                    <ext:Container runat="server" ID="Ctn12" Layout="FormLayout" ColumnWidth="0.5">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbxChonCanBo" CtCls="requiredData" ValueField="Id" DisplayField="FullName"
                                                ...
                                                <Listeners>
                                                    <Select Handler="hdfChonCanBo.setValue(cbxChonCanBo.getValue());txtDecisionNumber.enable();dfDecisionDate.enable();dfEffectiveDate.enable();dfLeaveDate.enable();" />
                    ...
                    <ext:Container runat="server" ID="Ctn15" Layout="ColumnLayout" Height="400" AnchorHorizontal="100%">
                        <Items>
                            <ext:Container runat="server" ID="Ctn17" Layout="FormLayout" ColumnWidth="0.66" Hidden="false" Height="380">
                                <Items>
                                    <ext:FieldSet runat="server" ID="FieldSet5" Title="Thông tin quyết định" Layout="FormLayout"
                                        AnchorHorizontal="100%" LabelWidth="110" Height="400">
                                        <Items>
                                                ...
                                                <Items>
                                                    <ext:Container runat="server" ID="Container2" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfLeaveDate" CtCls="requiredData" FieldLabel="Ngày tháng đi<span style='color:red'>*</span>" Disabled="true"
                                                                Editable="true" MaskRe="/[0-9|/]/" Format="dd/MM/yyyy" AnchorHorizontal="50%">
                                                                <Triggers>
                                                                    <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                                </Triggers>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtLeaveProject" FieldLabel="Dự án đi"
                                                                AnchorHorizontal="100%" />
                                                            <ext:TextField runat="server" ID="txtCurrentDepartment" FieldLabel="Đơn vị đang công tác"
                                                                AnchorHorizontal="100%" />
                                                            <ext:TextField runat="server" ID="txtNewPosition" FieldLabel="Chức vụ nơi đến" AnchorHorizontal="100%" />
                ...
                <Buttons>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdTransfer.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật thuyên chuyển, điều chuyển" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateTransfer"
                Modal="true" Constrain="true" Height="490">
                <Items>
                    ...
                    <ext:Container runat="server" ID="Container6" Layout="ColumnLayout" Height="400" AnchorHorizontal="100%">
                        <Items>
                            <ext:Container runat="server" ID="Container7" Layout="FormLayout" ColumnWidth="0.66" Hidden="false" Height="400">
                                <Items>
                                                ...
                                                <Items>
                                                    <ext:Container runat="server" ID="Container12" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfUpdateLeaveDate" CtCls="requiredData" FieldLabel="Ngày đi<span style='color:red'>*</span>" Disabled="true"
                                                                Editable="true" MaskRe="/[0-9|/]/" Format="dd/MM/yyyy" AnchorHorizontal="50%">
                                                                <Triggers>
                                                                    <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                                </Triggers>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtUpdateLeaveProject" FieldLabel="Dự án đi"
                                                                AnchorHorizontal="100%" />
                                                            <ext:TextField runat="server" ID="txtUpdateCurrentDepartment" FieldLabel="Đơn vị đang công tác"
                                                                AnchorHorizontal="100%" />
                                                            <ext:TextField runat="server" ID="txtUpdateNewPosition" FieldLabel="Chức vụ nơi đến" AnchorHorizontal="100%" />
                ...
                <Buttons>
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateTransfer.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
