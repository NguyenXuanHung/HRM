<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.RetirementManagement" Codebehind="RetirementManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputRetirement = function () {
            ...
            if (dfExpireDate.getValue() === '' || dfExpireDate.getValue().trim === '' || dfExpireDate.getValue() === null) {
                alert('Bạn chưa nhập thời hạn nghỉ hưu!');
                return false;
            }
            return true;
        }
        var checkUpdateRetirement = function () {
        ...
        var searchBoxCurrentDepartment = function (f, e) {
            hdfCurrentDepartmentTemp.setValue(cbxCurrentDepartment.getRawValue());
            if (hdfIsCurrentDepartment.getValue() === '1') {
                hdfIsCurrentDepartment.setValue('2');
            }
            if (cbxCurrentDepartment.getRawValue() === '') {
                hdfIsCurrentDepartment.reset();
            }
        }    
        var searchBoxCurrentDepartmentUpdate = function (f, e) {
            hdfUpdateCurrentDepartmentTemp.setValue(cbxUpdateCurrentDepartment.getRawValue());
            if (hdfIsUpdateCurrentDepartment.getValue() === '1') {
                hdfIsUpdateCurrentDepartment.setValue('2');
            }
            if (cbxUpdateCurrentDepartment.getRawValue() === '') {
                hdfIsUpdateCurrentDepartment.reset();
            }
        }
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <ext:Viewport ID="vp" runat="server" HideBorders="true">
                <Items>
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridMoveTo" TrackMouseOver="true" Header="false" runat="server"
                                    ...
                                    <ext:Toolbar runat="server" ID="toolbarFn">
                                        <Items>
                                            <ext:Button runat="server" ID="btnAdd" Text="Thêm" Icon="Add">
                                                <Listeners>
                                                    <Click Handler="wdRetirement.show();ResetFormBusiness();" />
                                                </Listeners>
                                            </ext:Button>
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="stBoNhiemChucVu">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
                                        ...
                                        <BaseParams>
                                            ...
                                            <ext:Parameter Name="businessType" Value="hdfBusinessType.getValue()" Mode="Raw" />
            ...
            <ext:Window runat="server" Title="Tạo quyết định nghỉ hưu" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdRetirement"
                ...
                <Items>
                            ...
                            <ext:Container runat="server" ID="Ctn11" Layout="ColumnLayout" Height="25" AnchorHorizontal="100%">
                                <Items>
                                    <ext:Container runat="server" ID="Ctn12" Layout="FormLayout" ColumnWidth="0.5">
                                        <Items>
                                            ...
                                            <ext:ComboBox ID="cbxChonCanBo" CtCls="requiredData" ValueField="Id" DisplayField="FullName"
                                                ...
                                                <Listeners>
                                                    <Select Handler="hdfChonCanBo.setValue(cbxChonCanBo.getValue());txtDecisionNumber.enable();dfDecisionDate.enable();dfExpireDate.enable();" />
                                    ...
                                    <ext:Container runat="server" ID="Ctn13" Layout="FormLayout" ColumnWidth="0.5">
                                        <Items>
                                            <ext:TextField runat="server" ID="txtCurrentPosition" FieldLabel="Chức vụ" AnchorHorizontal="100%"/>
                                        </Items>
                                    </ext:Container>
                                </Items>
                            </ext:Container>
                    ...
                    <ext:Container runat="server" ID="Ctn15" Layout="ColumnLayout" Height="320" AnchorHorizontal="100%">
                        <Items>
                            <ext:Container runat="server" ID="Ctn17" Layout="FormLayout" ColumnWidth="0.66" Hidden="false" Height="340">
                                <Items>
                                    <ext:FieldSet runat="server" ID="FieldSet5" Title="Thông tin quyết định" Layout="FormLayout"
                                        AnchorHorizontal="100%" LabelWidth="110" Height="320">
                                        <Items>
                                                ...
                                                <Items>
                                                    <ext:Container runat="server" ID="Container2" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:DateField runat="server" ID="dfExpireDate" CtCls="requiredData" FieldLabel="Thời gian nghỉ hưu<span style='color:red'>*</span>" Disabled="true"
                                                            ...
                                                            <ext:Hidden runat="server" ID="hdfIsCurrentDepartment" Text="0" />
                                                            <%-- 0: user enter text, 1: user select item, 2: user select and edit --%>
                                                            <ext:Hidden runat="server" ID="hdfCurrentDepartment" />
                                                            <ext:Hidden runat="server" ID="hdfCurrentDepartmentTemp" />
                                                            <ext:ComboBox runat="server" ID="cbxCurrentDepartment" DisplayField="Name" FieldLabel="Đơn vị công tác"
                                                                ...
                                                                <Listeners>
                                                                    <Select Handler="this.triggers[0].show();  hdfCurrentDepartment.setValue(cbxCurrentDepartment.getValue());
				                                                                            hdfIsCurrentDepartment.setValue('1');
				                                                                            hdfCurrentDepartmentTemp.setValue(cbxCurrentDepartment.getRawValue());" />
                                                                    <TriggerClick Handler="if (index == 0) { this.clearValue(); this.triggers[0].hide(); hdfIsCurrentDepartment.reset();hdfCurrentDepartmentTemp.reset();hdfCurrentDepartment.reset();  }" />
                                                                    <KeyUp Fn="searchBoxCurrentDepartment" />
                                                                    <Blur Handler="cbxCurrentDepartment.setRawValue(hdfCurrentDepartmentTemp.getValue());
			                                                                                if (hdfIsCurrentDepartment.getValue() != '1') {cbxCurrentDepartment.setValue(hdfCurrentDepartmentTemp.getValue());}" />
                                                                </Listeners>
                                                            </ext:ComboBox>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnCapNhat" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputRetirement();" />
                        </Listeners>
                        <DirectEvents>
                    ...
                    <ext:Button runat="server" ID="btnDongLai" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdRetirement.hide();ResetFormBusiness(); txtDescription.reset();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
                <Listeners>
            ...
            <ext:Window runat="server" Title="Cập nhật nghỉ hưu" Resizable="true" Layout="FormLayout"
                Padding="6" Width="870" Hidden="true" Icon="UserTick" ID="wdUpdateRetirement"
                ...
                <Items>
                            ...
                            <ext:Container runat="server" ID="Container3" Layout="ColumnLayout" Height="25" AnchorHorizontal="100%">
                                <Items>
                                    ...
                                    <ext:Container runat="server" ID="Container5" Layout="FormLayout" ColumnWidth="0.5">
                                        <Items>
                                            <ext:TextField runat="server" ID="txtUpdateCurrentPosition" FieldLabel="Chức vụ" AnchorHorizontal="100%"/>
                                        </Items>
                                    </ext:Container>
                                </Items>
                            </ext:Container>
                    ...
                    <ext:Container runat="server" ID="Container6" Layout="ColumnLayout" Height="320" AnchorHorizontal="100%">
                        <Items>
                            <ext:Container runat="server" ID="Container7" Layout="FormLayout" ColumnWidth="0.66" Hidden="false" Height="340">
                                <Items>
                                                    ...
                                                    <ext:Container runat="server" ID="Container12" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            <ext:TextField runat="server" ID="txtUpdateShortDecision" FieldLabel="Trích yếu quyết định"
                                                                AnchorHorizontal="100%"/>
                                                            <ext:DateField runat="server" ID="dfUpdateExpireDate" CtCls="requiredData" FieldLabel="Thời gian nghỉ hưu<span style='color:red'>*</span>" Disabled="true"
                                                                Editable="true" MaskRe="/[0-9|/]/" Format="dd/MM/yyyy" AnchorHorizontal="50%">
                                                                <Triggers>
                                                                    <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                                                                </Triggers>
                                                            ...
                                                            <ext:Hidden runat="server" ID="hdfIsUpdateCurrentDepartment" Text="0" />
                                                            <%-- 0: user enter text, 1: user select item, 2: user select and edit --%>
                                                            <ext:Hidden runat="server" ID="hdfUpdateCurrentDepartment" />
                                                            <ext:Hidden runat="server" ID="hdfUpdateCurrentDepartmentTemp" />
                                                            <ext:ComboBox runat="server" ID="cbxUpdateCurrentDepartment" DisplayField="Name" FieldLabel="Đơn vị công tác"
                                                                ValueField="Id" AnchorHorizontal="100%" TabIndex="3" Editable="true"
                                                                ItemSelector="div.list-item" MinChars="1" EmptyText="Gõ để tìm kiếm" LoadingText="Đang tải dữ liệu..."
                                                                EnableKeyEvents="true" StoreID="storeDepartment">
                                                                <Triggers>
                                                                ...
                                                                <Listeners>
                                                                    <Select Handler="this.triggers[0].show();  hdfUpdateCurrentDepartment.setValue(cbxUpdateCurrentDepartment.getValue());
				                                                                            hdfIsUpdateCurrentDepartment.setValue('1');
				                                                                            hdfUpdateCurrentDepartmentTemp.setValue(cbxUpdateCurrentDepartment.getRawValue());" />
                                                                    <TriggerClick Handler="if (index == 0) { this.clearValue(); this.triggers[0].hide(); hdfIsUpdateCurrentDepartment.reset();hdfUpdateCurrentDepartmentTemp.reset();hdfUpdateCurrentDepartment.reset();  }" />
                                                                    <KeyUp Fn="searchBoxCurrentDepartmentUpdate" />
                                                                    <Blur Handler="cbxUpdateCurrentDepartment.setRawValue(hdfUpdateCurrentDepartmentTemp.getValue());
			                                                                                if (hdfIsUpdateCurrentDepartment.getValue() != '1') {cbxUpdateCurrentDepartment.setValue(hdfUpdateCurrentDepartmentTemp.getValue());}" />
                                                                </Listeners>
                                                            </ext:ComboBox>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateAndSave" Text="Cập nhật và đóng lại" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkUpdateRetirement();" />
                        </Listeners>
                        <DirectEvents>
                            <Click OnEvent="InsertOrUpdate">
                                <EventMask ShowMask="true" Msg="Đang lưu dữ liệu. Vui lòng chờ..." />
                    ...
                    <ext:Button runat="server" ID="Button6" Text="Đóng lại" Icon="Decline">
                        <Listeners>
                            <Click Handler="wdUpdateRetirement.hide();" />
                        </Listeners>
                    </ext:Button>
                </Buttons>
            </ext:Window>
