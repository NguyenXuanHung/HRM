<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Management.MoveFromManagement" Codebehind="MoveFromManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script>
        var checkInputMoveFrom = function () {
        ...
        var checkUpdateMoveFrom = function () {
...
<body>
    <form id="form1" runat="server">
        <div>
                    ...
                    <ext:BorderLayout runat="server" ID="brlayout">
                        <Center>
                            <ext:GridPanel ID="gridMoveTo" TrackMouseOver="true" Header="false" runat="server"
                                ...
                                <Store>
                                    <ext:Store runat="server" ID="storeMoveFrom">
                                        <Proxy>
                                            <ext:HttpProxy Method="POST" Url="~/Services/BaseHandler.ashx" />
                                        </Proxy>
                                        <AutoLoadParams>
            ...
            <ext:Window runat="server" Title="Tạo quyết định điều động đi" Resizable="true" Layout="FormLayout"
                                                ...
                                                <Items>
                                                    <ext:Container runat="server" ID="Container2" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtNewPosition" FieldLabel="Chức vụ điều động" AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnCapNhat" Text="Cập nhật" Icon="Disk">
                        <Listeners>
                            <Click Handler="return checkInputMoveFrom();" />
                        </Listeners>
                        <DirectEvents>
            ...
            <ext:Window runat="server" Title="Cập nhật điều động đi" Resizable="true" Layout="FormLayout"
                                                ...
                                                <Items>
                                                    <ext:Container runat="server" ID="Container12" Layout="FormLayout" ColumnWidth="0.5"
                                                        ...
                                                        <Items>
                                                            ...
                                                            <ext:TextField runat="server" ID="txtUpdateNewPosition" FieldLabel="Chức vụ điều động" AnchorHorizontal="100%"/>
                ...
                <Buttons>
                    <ext:Button runat="server" ID="btnUpdateAndSave" Text="Cập nhật và đóng lại" Icon="Disk">
                         <Listeners>
                            <Click Handler="return checkUpdateMoveFrom();" />
                        </Listeners>
                        <DirectEvents>
                            <Click OnEvent="InsertOrUpdate">
                                <EventMask ShowMask="true" Msg="Đang lưu dữ liệu. Vui lòng chờ..." />
