<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.EmployeeSettingHJM" Codebehind="EmployeeSettingHJM.aspx.cs" %>

<%@ Register Assembly="Ext.Net" Namespace="Ext.Net" TagPrefix="ext" %>
<%@ Register Src="/Modules/UC/Sample.ascx" TagName="ucSample" TagPrefix="uc" %>
...
<head runat="server">
    ...
    <link href="/Resource/css/hjm/EmployeeSetting.css" rel="stylesheet" />
                                    ...
                                    <div class="col col-10">
                                            ...
                                            <div id="ThongTinCaNhan">
                                                ...
                                                <div id="info">
                                                    <ext:TextField ID="txtFullName" runat="server" CtCls="requiredData" FieldLabel="<b>&nbsp1) Họ và tên khai sinh</b><span style='color:red;'>*</span>"
                                                        AllowBlank="false" AnchorHorizontal="98%" MaxLength="50" MaxLengthText="Bạn chỉ được nhập tối đa 50 ký tự"
                                        ...
                                        <div class="clr">
						                                ...
						                                <div class="list-item"> 
                                                            ...
                                                            <Listeners>
                                                                ...
                                                                <TriggerClick Handler="if (index == 0) { this.clearValue(); this.triggers[0].hide(); }; cbxManagementLevel.setValue(''); hdfManagementLevelId.setValue('');
                                                                            if (index == 1) { hdfCurrentCatalogName.setValue('cat_ManagementLevel'); hdfCurrentCatalogGroupName.setValue('managementlevel'); hdfEnableCatalogGroup.setValue('true'); wdAddCategoryGroup.show(); this.collapse(); }" />
                                                            </Listeners>
                                                        </ext:ComboBox>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <Reader>
                                                            <ext:JsonReader IDProperty="Id">
                                                                <Fields>
                                                                    ...
                                                                    <ext:RecordField Name="GraduateTypeName" />
                                                                    <ext:RecordField Name="GraduationTypeId" DefaultValue="0" />
                                            ...
                                            <ext:GridPanel ID="GridPanelSalary" runat="server" Width="745" Height="260"
                                                        ...
                                                        <Reader>
                                                            <ext:JsonReader IDProperty="Id">
                                                                <Fields>
                                                                    ...
                                                                    <ext:RecordField Name="Grade" DefaultValue="0" />
                                                                    <ext:RecordField Name="Factor" DefaultValue="0" />
                                                                    <ext:RecordField Name="InsuranceSalary" DefaultValue="0" />
                                                                    <ext:RecordField Name="ContractSalary" DefaultValue="0" />
                                                                    <ext:RecordField Name="GrossSalary" DefaultValue="0" />
                                                                    <ext:RecordField Name="NetSalary" DefaultValue="0" />
                                                                    <ext:RecordField Name="PercentageSalary" DefaultValue="0" />
                                                                    <ext:RecordField Name="PercentageLeader" DefaultValue="0" />
                                                                    <ext:RecordField Name="PercentageOverGrade" DefaultValue="0" />
                                                ...
                                                <ColumnModel ID="ColumnModel5" runat="server">
                                                    <Columns>
                                                        ...
                                                        <ext:Column ColumnID="Name" Width="95" Header="Tên quyết định" DataIndex="Name">
                                                            <Editor>
                                                        ...
                                                        <ext:Column ColumnID="Grade" Width="95" Header="Bậc lương" DataIndex="Grade"
                                                            Align="Right">
                                                            ...
                                                            <Editor>
                                                                <ext:ComboBox runat="server" ID="cbxSalaryGrade" CtCls="requiredData" Width="235" Disabled="true"
                                                                    ...
                                                                    <Listeners>
                                                                        <Select Handler="this.triggers[0].show(); hdfSalaryGradeGrid.setValue(this.getValue()); updateSalaryProcess('Grade', this.getValue());
                                                        ...
                                                        <ext:Column ColumnID="Factor" Width="100" Header="Hệ số lương" DataIndex="Factor"
                                                            Align="Right">
                                                            <Editor>
                                                        ...
                                                        <ext:DateColumn Format="dd/MM/yyyy" Width="125" ColumnID="DecisionDate" Header="Ngày quyết định"
                                                            ...
                                                            <Editor>
                                                                <ext:DateField ID="dfDecisionDate" runat="server" AnchorHorizontal="98%" MaskRe="/[0-9\/]/" Format="dd/MM/yyyy"
                                                        ...
                                                        <ext:DateColumn Format="dd/MM/yyyy" Width="115" ColumnID="EffectiveDate" Header="Ngày có hiệu lực <span style='color:red'>*</span>"
                                                            ...
                                                            <Editor>
                                                                <ext:DateField ID="dfEffectiveDate" runat="server" AnchorHorizontal="98%" MaskRe="/[0-9\/]/" Format="dd/MM/yyyy" CtCls="requiredData"
                                                        ...
                                                        <ext:Column ColumnID="InsuranceSalary" Width="150" Header="Mức lương đóng BHXH" DataIndex="InsuranceSalary"
                                                            Align="Right">
                                                            <Editor>
                                                                <ext:NumberField runat="server" AllowNegative="false" TabIndex="133" />
                                                            </Editor>
                                                        </ext:Column>
                                                        <ext:Column ColumnID="SignerName" Width="110" Header="Người quyết định" DataIndex="SignerName">
                                                            <Editor>
                                            ...
                                            <ext:GridPanel ID="gridAbility" runat="server" Width="745" Height="260" AutoExpandColumn="Note">
                                                        ...
                                                        <Reader>
                                                            <ext:JsonReader IDProperty="Id">
                                                                <Fields>
                                                                    ...
                                                                    <ext:RecordField Name="GraduationTypeId" DefaultValue="0" />
                                                                    <ext:RecordField Name="GraduationTypeName" />
                                                                    <ext:RecordField Name="Note" />
                                                                    <ext:RecordField Name="IsApproved" DefaultValue="false" />
                                                                </Fields>
                                                            </ext:JsonReader>
                                                ...
                                                <ColumnModel>
                                                    <Columns>
                                                        ...
                                                        <ext:Column Header="Mức đạt" DataIndex="GraduationTypeName" Width="200" Sortable="true"
                                                            Align="Left">
                                                            ...
                                                            <Editor>
                                                                <ext:ComboBox runat="server" ID="cbKhaNangXepLoai" DisplayField="Name" TabIndex="151" PageSize="15"
                                                                    ...
                                                                    <Listeners>
                                                                        <Select Handler="this.triggers[0].show();updateGridNangLucST('GraduationTypeId',this.getValue());" />
                                                                        <TriggerClick Handler="if (index == 0) { this.clearValue(); this.triggers[0].hide(); }" />
                                                                    </Listeners>
                                                                </ext:ComboBox>
                                                            </Editor>
                                            ...
                                            <ext:GridPanel ID="GridContract" runat="server" Width="745" Height="260">
                                                ...
                                                <ColumnModel>
                                                    <Columns>
                                                        ...
                                                        <ext:Column Header="Loại hợp đồng <span style='color:red'>*</span>" DataIndex="ContractTypeName" Width="150" Sortable="false"
                                                            Align="Left">
                                                            ...
                                                            <Editor>
                                                                <ext:ComboBox runat="server" ID="cbxContract" DisplayField="Name"
                                                                    ...
                                                                    <Listeners>
                                                                        ...
                                                                        <Select Handler="this.triggers[0].show();updateContract('ContractTypeId', this.getValue());" />
                                                                        <TriggerClick Handler="if (index == 0) { this.clearValue(); this.triggers[0].hide(); }" />
                                                                    </Listeners>
                                                                </ext:ComboBox>
                                                            </Editor>
                                            ...
                                            <div>
                                                ...
                                                <br />
                                                <ext:TextField ID="txtContactPhoneNumber" runat="server" MaxLength="50" Width="500" LabelWidth="200" FieldLabel="<b>38.3) Số điện thoại(di động)</b>" Hidden="True"/>
                                                <p class="label">38.3) Địa chỉ</p>
