<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.ProfileHuman.Default" CodeBehind="Default.aspx.cs" %>
...
<body>
    <form id="frmProfileHumanDefault" runat="server">
        ...
        <ext:Window Modal="true" Hidden="true" runat="server" Layout="BorderLayout" ID="wdInput"
            ...
            <Listeners>
                <BeforeShow Handler="TabPanel1.remove(0); addHomePage(TabPanel1, 'Homepage', '../ProfileHuman/EmployeeEnterprise.aspx?Event='+hdfEven.getValue()+'&MenuID='+hdfMenuID.getValue()+'&PrKeyHoSo='+hdfRecordId.getValue(), 'Cập nhật ');" />
            </Listeners>
            <Buttons>
