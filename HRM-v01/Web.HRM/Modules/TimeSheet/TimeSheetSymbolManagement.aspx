<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.TimeSheet.TimeSheetSymbolManagement" CodeBehind="TimeSheetSymbolManagement.aspx.cs" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        var checkInputTimeSheetSymbol = function () {
            ...
            if (dropDownSymbol.getValue() == '' || dropDownSymbol.getValue().trim == '') {
                alert('Bạn chưa chọn màu cho ký hiệu chấm công!');
                return false;
            }

            if (hdfGroupSymbolId.getValue() == '' || hdfGroupSymbolId.getValue().trim == '') {
    ...
    <form id="form1" runat="server">
        <div id="main">
                                        ...
                                        <Reader>
                                            <ext:JsonReader IDProperty="Id" Root="Data" TotalProperty="TotalRecords">
                                                <Fields>
                                                    ...
                                                    <ext:RecordField Name="GroupSymbolId" />
            ...
            <ext:Window runat="server" Title="Tạo mới ký hiệu chấm công" Resizable="true" Layout="FormLayout"
                Padding="6" Width="800" Hidden="true" Icon="UserTick" ID="wdTimeSheetSymbol"
                ...
                <Items>
                    ...
                    <ext:TextField runat="server" ID="txtSymbolName" CtCls="requiredData" FieldLabel="Diễn giải<span style='color:red;'>*</span>"
                        AnchorHorizontal="100%" />
                    <ext:TextField runat="server" ID="txtSymbolColor" FieldLabel="Màu ký hiệu" AnchorHorizontal="100%" Hidden="True"/>
                    <ext:DropDownField runat="server" ID="dropDownSymbol" Editable="false" FieldLabel="Màu ký hiệu" AnchorHorizontal="100%" CtCls="requiredData">
                        <Component>
                    ...
                    <ext:ComboBox runat="server" ID="cbxGroupSymbol" FieldLabel="Nhóm ký hiệu"
                        ...
                        LabelWidth="252" Width="422" ItemSelector="div.list-item" CtCls="requiredData" PageSize="10">
                        <Triggers>
                            <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                        </Triggers>
                        ...
                        <Listeners>
                            <Select Handler="this.triggers[0].show();hdfGroupSymbolId.setValue(cbxGroupSymbol.getValue());" />
                            <TriggerClick Handler="if (index == 0) { this.clearValue(); this.triggers[0].hide(); hdfGroupSymbolId.reset(); };" />
                        </Listeners>
                    </ext:ComboBox>
