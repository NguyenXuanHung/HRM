<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.TimeKeeping.TimeSheetManagementManual" Codebehind="TimeSheetManagementManual.aspx.cs" %>
                            ...
                            <ext:GridPanel ID="gridTimeSheet" TrackMouseOver="true" Header="true" runat="server"
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="TotalPaidLeaveT" Header="Tổng số ngày nghỉ phép hưởng lương (P)" Width="150" Align="Left" Locked="true" DataIndex="TotalPaidLeaveT">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
                                        <ext:Column ColumnID="TotalUnpaidLeaveP" Header="Tổng số ngày nghỉ phép không hưởng lương (R)" Width="150" Align="Left" Locked="true" DataIndex="TotalUnpaidLeaveP">
                                            <Renderer Fn="RenderTotal" />
                                        </ext:Column>
