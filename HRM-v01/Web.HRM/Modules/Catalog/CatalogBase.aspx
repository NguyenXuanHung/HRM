<%@ Page Language="C#" AutoEventWireup="true" Inherits="Web.HRM.Modules.Catalog.CatalogBase" CodeBehind="CatalogBase.aspx.cs" %>
...
<body>
    <form id="form1" runat="server">
        <div id="main">
            ...
            <!-- hidden field -->
            <ext:Hidden runat="server" ID="hdfObjName" />
            ...
            <ext:Store ID="storeCatalog" AutoSave="true" runat="server">
                ...
                <BaseParams>
                    <ext:Parameter Name="objname" Value="hdfObjName.getValue()" Mode="Raw" />
                    <ext:Parameter Name="query" Value="txtKeyword.getValue()" Mode="Raw" />
                    <ext:Parameter Name="order" Value="hdfOrder.getValue()" Mode="Raw" />
                    <ext:Parameter Name="group" Value="hdfCatalogGroup.getValue()" Mode="Raw" />
                </BaseParams>
                <Reader>
                            ...
                            <ext:GridPanel runat="server" ID="gpCatalog" StoreID="storeCatalog" TrackMouseOver="true" Header="false" StripeRows="true" AutoExpandColumn="Description"
                                ...
                                <ColumnModel>
                                    <Columns>
                                        ...
                                        <ext:Column ColumnID="GroupName" Header="Nhóm" Width="200" DataIndex="GroupName" />
                                        <ext:Column ColumnID="StatusName" Header="Trạng thái" Width="200" DataIndex="StatusName">
