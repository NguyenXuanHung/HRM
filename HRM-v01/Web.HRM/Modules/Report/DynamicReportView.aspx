<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DynamicReportView.aspx.cs" Inherits="Web.HRM.Modules.Report.DynamicReportView" %>
...
<%@ Register Src="~/Modules/UC/ChooseEmployee.ascx" TagPrefix="UC" TagName="ChooseEmployee" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <ext:Hidden runat="server" ID="hdfPayrollConfigId" />
        ...
        <!-- Select user -->
        <UC:ChooseEmployee runat="server" ID="ucChooseEmployee" ChiChonMotCanBo="false" DisplayWorkingStatus="TatCa" />
        <!-- store -->
        ...
        <ext:Window runat="server" ID="wdReportFilter" Hidden="true" Modal="true" AutoHeight="true" ConstrainHeader="true" Width="650" Icon="Printer" Padding="10" Constrain="true"
            ...
            <Items>
                ...
                <ext:Container runat="server" Layout="ColumnLayout" AnchorHorizontal="100%" Height="30">
                    <Items>
                        <ext:Container runat="server" ColumnWidth="0.6" Layout="FormLayout" AutoHeight="true" ID="ctnDepartment">
                            <Items>
                                <ext:TriggerField runat="server" ID="txtSelectedDepartments" CtCls="requiredData" FieldLabel="Đơn vị" AnchorHorizontal="100%" Visible="False">
                                    <Listeners>
                ...
                <ext:Container runat="server" ColumnWidth="0.6" Layout="FormLayout" AutoHeight="true" ID="ctnChooseEmployee">
                    <Items>
                ...
                <ext:Container runat="server" Layout="ColumnLayout" AnchorHorizontal="100%" Height="30">
                    <Items>
                        <ext:Container runat="server" ID="ctnStartDate" Layout="FormLayout" ColumnWidth="0.45" AutoHeight="true">
                            <Items>
                                <ext:DateField ID="dfStartDate" runat="server" FieldLabel="Từ ngày" AnchorHorizontal="100%" Format="d/M/yyyy" Visible="False"/>
                            </Items>
                        </ext:Container>
                        <ext:Container runat="server" ColumnWidth="0.1"></ext:Container>
                ...
                <ext:Container runat="server" ColumnWidth="0.6" Layout="FormLayout" AutoHeight="true">
                    <Items>
                        <ext:Hidden runat="server" ID="hdfTimeSheetReport"></ext:Hidden>
                        <ext:ComboBox runat="server" ID="cboTimeSheetReport" FieldLabel="Chọn bảng chấm công"
                            ...
                            <Listeners>
                                <Select Handler="this.triggers[0].show(); hdfTimeSheetReport.setValue(cboTimeSheetReport.getValue());"></Select>
                ...
                <ext:Container runat="server" ColumnWidth="0.6" Layout="FormLayout" AutoHeight="true">
                    <Items>
                        ...
                        <ext:ComboBox runat="server" ID="cboPayroll" FieldLabel="Chọn bảng lương" DisplayField="Title"
                            MinChars="1" ValueField="Id" AnchorHorizontal="100%" Editable="true" LabelWidth="252" Width="422"
                            ItemSelector="div.list-item" CtCls="requiredData" Visible="False" PageSize="10">
                            <Triggers>
                                <ext:FieldTrigger Icon="Clear" HideTrigger="true" />
                            </Triggers>
                            <Template runat="server">
                            ...
                            <Store>
                                <ext:Store ID="storePayroll" AutoSave="true" runat="server">
                                    <Proxy>
                                        <ext:HttpProxy Method="POST" Url="~/Services/HandlerPayroll.ashx" />
                                    </Proxy>
                                    <BaseParams>
                                        <ext:Parameter Name="configId" Value="hdfPayrollConfigId.getValue()" Mode="Raw" />
                                        <ext:Parameter Name="departments" Value="hdfSelectedDepartmentIds.getValue()" Mode="Raw" />
                                    </BaseParams>
                                    <Reader>
                                        <ext:JsonReader IDProperty="Id" Root="Data" TotalProperty="TotalRecords">
                                            <Fields>
                            ...
                            <Listeners>
                                <Select Handler="this.triggers[0].show();hdfPayrollId.setValue(cboPayroll.getValue());" />
                ...
                <ext:FieldSet runat="server" ID="fsLabel" Title="Nhãn">
                    <Items>
                        <ext:Container runat="server" Layout="FormLayout" AnchorHorizontal="100%">
                            <Items>
                                ...
                                <ext:Container runat="server" Layout="ColumnLayout" LabelAlign="Top" Height="25">
                                    <Items>
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth="0.32">
                                            <Items>
                                                <ext:TextField runat="server" ID="txtCreatedByNote" FieldLabel="Ghi chú" LabelWidth="60" AnchorHorizontal="100%" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container runat="server" ColumnWidth="0.02"></ext:Container>
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth="0.32">
                                            <Items>
                                                <ext:TextField runat="server" ID="txtReviewedByNote" FieldLabel="Ghi chú" LabelWidth="60" AnchorHorizontal="100%" />
                                            </Items>
                                        </ext:Container>
                                        <ext:Container runat="server" ColumnWidth="0.02"></ext:Container>
                                        <ext:Container runat="server" Layout="FormLayout" ColumnWidth="0.32">
                                            <Items>
                                                <ext:TextField runat="server" ID="txtSignedByNote" FieldLabel="Ghi chú" LabelWidth="60" AnchorHorizontal="100%" />
                                            </Items>
                                        </ext:Container>
                                    </Items>
                                </ext:Container>
        ...
        <ext:Window runat="server" ID="wdDepartment" Hidden="true" AutoHeight="true" Layout="FormLayout" Width="300" Padding="0" Resizable="false" Icon="Key" Modal="true" Title="Chọn đơn vị">
            <Items>
                <ext:TreePanel ID="pnlTreeDepartments" runat="server" Width="350" Height="300" Border="false" RootVisible="false" AutoScroll="true">
                    <Listeners>
            ...
            <Buttons>
                <ext:Button runat="server" Text="Lưu" ID="btnSaveSelectedDepartments" Icon="Disk">
                    <Listeners>
