<%@ Control Language="C#" AutoEventWireup="true"
    Inherits="Web.HRM.Modules.UC.UpdateImageEmployeeSeries" Codebehind="UpdateImageEmployeeSeries.ascx.cs" %>
...
<script type="text/javascript">
    ...
    var CheckBeforeUpload = function (el) {
        if (CapNhatAnhHangLoat1_rdMaCanBo.checked == false  && CapNhatAnhHangLoat1_rdSoCMND.checked == false) {
...
<ext:Window runat="server" ID="wdCapNhatAnhHangLoat" Width="500" Icon="Images" Title="Cập nhật ảnh hàng loạt"
    ...
    <Items>
        <ext:FormPanel ID="BasicForm" runat="server" Border="false" MonitorValid="true">
            ...
            <Listeners>
                <ClientValidation Handler="#{btnCapNhatAnh}.setDisabled(!valid || (#{rdMaCanBo}.checked == false  && #{rdSoCMND}.checked == false));" />
            </Listeners>
        </ext:FormPanel>
    </Items>
    <Buttons>
    ...
    <Listeners>
        <Hide Handler="#{fufChonAnh}.reset();#{rdMaCanBo}.reset();#{dpfSizeNow}.reset();" />
    </Listeners>
</ext:Window>
