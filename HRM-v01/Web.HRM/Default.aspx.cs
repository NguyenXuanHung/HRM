    ...
    public partial class Default : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!ExtNet.IsAjaxRequest)
            {
                ...
                {
                    // show system menu
                    toolbarSeperatorSystem.Visible = true;
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        protected void UpdatePassword(object sender, DirectEventArgs e)
        {
            // init return mesage
            ...
            if (UserServices.ChangePassword(CurrentUser.User.UserName, txtOldPassword.Text, txtNewPassword.Text, ref message) != null)
            {
                ...
                // log action
                SystemLogController.Create(new SystemLogModel(CurrentUser.User.UserName, "Default", SystemAction.Other,
                    SystemLogType.UserAction, "Đổi mật khẩu"));
            }
            else
            {
                // show error
        ...
        {
            // log action
            SystemLogController.Create(new SystemLogModel(CurrentUser.User.UserName, "Default", SystemAction.Logout,
                SystemLogType.UserAction, "Đăng xuất"));
        ...
        private void LoadMenuTop()
        {
            ...
            var lstMenu = MenuController.GetAll(null, null, null, MenuGroup.MenuTop, MenuStatus.Active, userId, false,
                null, null);
        ...
        private void LoadMenuLeft()
        {
            ...
            {
                Html = "<b style='color:#15428B !important;font-family:verdana !important;'>{0}</b>".FormatWith(Resource.Get("ApplicationName"))
            };
        ...
        /// <summary>
        /// Load sub items of each root item in menu left
        /// </summary>
